...
//sampler sampler Tweak_N10SmpSC 0:22
//sampler sampler Tweak_N31SmpSC 0:23
...
//texture texture2D Tweak_N10 0:3:0:22
//texture texture2D Tweak_N31 0:4:0:23
...
//texture texture2DArray Tweak_N10ArrSC 0:34:0:22
//texture texture2DArray Tweak_N31ArrSC 0:35:0:23
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N10 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N31 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 82 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N10 83 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N31 84 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 85 -1
//spec_const int Tweak_N10Layout 86 0
//spec_const int Tweak_N31Layout 87 0
...
#endif
#ifndef Tweak_N31HasSwappedViews
#define Tweak_N31HasSwappedViews 0
#elif Tweak_N31HasSwappedViews==1
#undef Tweak_N31HasSwappedViews
#define Tweak_N31HasSwappedViews 1
#endif
#ifndef Tweak_N31Layout
#define Tweak_N31Layout 0
#endif
#ifndef SC_USE_UV_TRANSFORM_Tweak_N31
#define SC_USE_UV_TRANSFORM_Tweak_N31 0
#elif SC_USE_UV_TRANSFORM_Tweak_N31==1
#undef SC_USE_UV_TRANSFORM_Tweak_N31
#define SC_USE_UV_TRANSFORM_Tweak_N31 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_Tweak_N31
#define SC_SOFTWARE_WRAP_MODE_U_Tweak_N31 -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_Tweak_N31
#define SC_SOFTWARE_WRAP_MODE_V_Tweak_N31 -1
#endif
#ifndef SC_USE_UV_MIN_MAX_Tweak_N31
#define SC_USE_UV_MIN_MAX_Tweak_N31 0
#elif SC_USE_UV_MIN_MAX_Tweak_N31==1
#undef SC_USE_UV_MIN_MAX_Tweak_N31
#define SC_USE_UV_MIN_MAX_Tweak_N31 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_Tweak_N31
#define SC_USE_CLAMP_TO_BORDER_Tweak_N31 0
#elif SC_USE_CLAMP_TO_BORDER_Tweak_N31==1
#undef SC_USE_CLAMP_TO_BORDER_Tweak_N31
#define SC_USE_CLAMP_TO_BORDER_Tweak_N31 1
#endif
#ifndef sc_DepthOnly
...
uniform bool AnimatedArrow;
uniform float ArrowSpeed;
uniform mat3 Tweak_N31Transform;
uniform vec4 Tweak_N31UvMinMax;
uniform vec4 Tweak_N31BorderColor;
uniform float Port_Input1_N002;
uniform vec2 Port_SpriteCount_N029;
uniform float Port_MaxFrames_N029;
uniform vec2 Port_UVCoord_N029;
uniform float Port_FrameOffset_N029;
uniform float Port_SecondOffset_N029;
...
uniform float Port_Value0_N005;
uniform float Port_Default_N005;
...
uniform sampler2D Tweak_N31;
uniform sampler2DArray Tweak_N31ArrSC;
...
int Tweak_N31GetStereoViewIndex()
{
int l9_0;
#if (Tweak_N31HasSwappedViews)
{
...
vec2 l9_3=l9_1-Port_Center_N019;
float l9_4=floor(float(AnimatedArrow));
float l9_5;
if (l9_4==0.0)
{
l9_5=Port_Value0_N005;
}
else
{
float l9_6;
if (l9_4==1.0)
{
float l9_7=floor(Port_SpriteCount_N029.x);
float l9_8=floor(Port_SpriteCount_N029.y);
float l9_9=1.0/l9_7;
float l9_10=1.0/l9_8;
float l9_11=floor(mod(((sc_Time.x+Port_SecondOffset_N029)*(ArrowSpeed*Port_Input1_N002))+floor(Port_FrameOffset_N029),min(l9_7*l9_8,floor(Port_MaxFrames_N029))));
float l9_12=(l9_9*Port_UVCoord_N029.x)+(mod(l9_11,l9_7)*l9_9);
float l9_13=((1.0-l9_10)-(floor(l9_11/l9_7)*l9_10))+(l9_10*Port_UVCoord_N029.y);
vec4 l9_14;
#if (Tweak_N31Layout==2)
{
bool l9_15=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N31)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N31)!=0));
float l9_16=l9_12;
sc_SoftwareWrapEarly(l9_16,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N31,SC_SOFTWARE_WRAP_MODE_V_Tweak_N31).x);
float l9_17=l9_16;
float l9_18=l9_13;
sc_SoftwareWrapEarly(l9_18,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N31,SC_SOFTWARE_WRAP_MODE_V_Tweak_N31).y);
float l9_19=l9_18;
vec2 l9_20;
float l9_21;
#if (SC_USE_UV_MIN_MAX_Tweak_N31)
{
bool l9_22;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N31)
{
l9_22=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N31,SC_SOFTWARE_WRAP_MODE_V_Tweak_N31).x==3;
}
#else
{
l9_22=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N31)!=0);
}
#endif
float l9_23=l9_17;
float l9_24=1.0;
sc_ClampUV(l9_23,Tweak_N31UvMinMax.x,Tweak_N31UvMinMax.z,l9_22,l9_24);
float l9_25=l9_23;
float l9_26=l9_24;
bool l9_27;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N31)
{
l9_27=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N31,SC_SOFTWARE_WRAP_MODE_V_Tweak_N31).y==3;
}
#else
{
l9_27=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N31)!=0);
}
#endif
float l9_28=l9_19;
float l9_29=l9_26;
sc_ClampUV(l9_28,Tweak_N31UvMinMax.y,Tweak_N31UvMinMax.w,l9_27,l9_29);
l9_21=l9_29;
...
#endif
vec2 l9_30=sc_TransformUV(l9_20,(int(SC_USE_UV_TRANSFORM_Tweak_N31)!=0),Tweak_N31Transform);
float l9_31=l9_30.x;
float l9_32=l9_21;
sc_SoftwareWrapLate(l9_31,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N31,SC_SOFTWARE_WRAP_MODE_V_Tweak_N31).x,l9_15,l9_32);
float l9_33=l9_30.y;
float l9_34=l9_32;
sc_SoftwareWrapLate(l9_33,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N31,SC_SOFTWARE_WRAP_MODE_V_Tweak_N31).y,l9_15,l9_34);
float l9_35=l9_34;
vec3 l9_36=sc_SamplingCoordsViewToGlobal(vec2(l9_31,l9_33),Tweak_N31Layout,Tweak_N31GetStereoViewIndex());
vec4 l9_37=texture(Tweak_N31ArrSC,l9_36,0.0);
vec4 l9_38;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N31)
{
l9_38=mix(Tweak_N31BorderColor,l9_37,vec4(l9_35));
}
#else
{
l9_38=l9_37;
...
#else
{
bool l9_39=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N31)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N31)!=0));
float l9_40=l9_12;
sc_SoftwareWrapEarly(l9_40,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N31,SC_SOFTWARE_WRAP_MODE_V_Tweak_N31).x);
float l9_41=l9_40;
float l9_42=l9_13;
sc_SoftwareWrapEarly(l9_42,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N31,SC_SOFTWARE_WRAP_MODE_V_Tweak_N31).y);
float l9_43=l9_42;
vec2 l9_44;
float l9_45;
#if (SC_USE_UV_MIN_MAX_Tweak_N31)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N31)
{
l9_46=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N31,SC_SOFTWARE_WRAP_MODE_V_Tweak_N31).x==3;
}
#else
{
l9_46=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N31)!=0);
}
#endif
float l9_47=l9_41;
float l9_48=1.0;
sc_ClampUV(l9_47,Tweak_N31UvMinMax.x,Tweak_N31UvMinMax.z,l9_46,l9_48);
float l9_49=l9_47;
float l9_50=l9_48;
bool l9_51;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N31)
{
l9_51=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N31,SC_SOFTWARE_WRAP_MODE_V_Tweak_N31).y==3;
}
#else
{
l9_51=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N31)!=0);
}
#endif
float l9_52=l9_43;
float l9_53=l9_50;
sc_ClampUV(l9_52,Tweak_N31UvMinMax.y,Tweak_N31UvMinMax.w,l9_51,l9_53);
l9_45=l9_53;
...
#endif
vec2 l9_54=sc_TransformUV(l9_44,(int(SC_USE_UV_TRANSFORM_Tweak_N31)!=0),Tweak_N31Transform);
float l9_55=l9_54.x;
float l9_56=l9_45;
sc_SoftwareWrapLate(l9_55,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N31,SC_SOFTWARE_WRAP_MODE_V_Tweak_N31).x,l9_39,l9_56);
float l9_57=l9_54.y;
float l9_58=l9_56;
sc_SoftwareWrapLate(l9_57,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N31,SC_SOFTWARE_WRAP_MODE_V_Tweak_N31).y,l9_39,l9_58);
float l9_59=l9_58;
vec3 l9_60=sc_SamplingCoordsViewToGlobal(vec2(l9_55,l9_57),Tweak_N31Layout,Tweak_N31GetStereoViewIndex());
vec4 l9_61=texture(Tweak_N31,l9_60.xy,0.0);
vec4 l9_62;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N31)
{
l9_62=mix(Tweak_N31BorderColor,l9_61,vec4(l9_59));
}
#else
{
l9_62=l9_61;
...
#endif
l9_6=(l9_14.x*Port_Input1_N025)+Port_Input1_N032;
}
else
{
l9_6=Port_Default_N005;
}
l9_5=l9_6;
}
vec2 l9_63=vec2(Port_Value1_N023,l9_5);
vec2 l9_64=((l9_3*Port_Scale_N019)+Port_Center_N019)+l9_63;
vec4 l9_65;
#if (Tweak_N10Layout==2)
{
bool l9_66=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N10)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N10)!=0));
float l9_67=l9_64.x;
sc_SoftwareWrapEarly(l9_67,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N10,SC_SOFTWARE_WRAP_MODE_V_Tweak_N10).x);
float l9_68=l9_67;
float l9_69=l9_64.y;
sc_SoftwareWrapEarly(l9_69,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N10,SC_SOFTWARE_WRAP_MODE_V_Tweak_N10).y);
float l9_70=l9_69;
vec2 l9_71;
float l9_72;
...
{
l9_73=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N10,SC_SOFTWARE_WRAP_MODE_V_Tweak_N10).x==3;
}
#else
{
l9_73=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N10)!=0);
}
#endif
float l9_74=l9_68;
float l9_75=1.0;
sc_ClampUV(l9_74,Tweak_N10UvMinMax.x,Tweak_N10UvMinMax.z,l9_73,l9_75);
float l9_76=l9_74;
float l9_77=l9_75;
bool l9_78;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N10)
{
l9_78=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N10,SC_SOFTWARE_WRAP_MODE_V_Tweak_N10).y==3;
}
#else
{
l9_78=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N10)!=0);
}
#endif
float l9_79=l9_70;
float l9_80=l9_77;
sc_ClampUV(l9_79,Tweak_N10UvMinMax.y,Tweak_N10UvMinMax.w,l9_78,l9_80);
l9_72=l9_80;
...
#endif
vec2 l9_81=sc_TransformUV(l9_71,(int(SC_USE_UV_TRANSFORM_Tweak_N10)!=0),Tweak_N10Transform);
float l9_82=l9_81.x;
float l9_83=l9_72;
sc_SoftwareWrapLate(l9_82,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N10,SC_SOFTWARE_WRAP_MODE_V_Tweak_N10).x,l9_66,l9_83);
float l9_84=l9_81.y;
float l9_85=l9_83;
sc_SoftwareWrapLate(l9_84,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N10,SC_SOFTWARE_WRAP_MODE_V_Tweak_N10).y,l9_66,l9_85);
float l9_86=l9_85;
vec3 l9_87=sc_SamplingCoordsViewToGlobal(vec2(l9_82,l9_84),Tweak_N10Layout,Tweak_N10GetStereoViewIndex());
vec4 l9_88=texture(Tweak_N10ArrSC,l9_87,0.0);
vec4 l9_89;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N10)
{
l9_89=mix(Tweak_N10BorderColor,l9_88,vec4(l9_86));
}
#else
{
l9_89=l9_88;
...
#else
{
bool l9_90=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N10)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N10)!=0));
float l9_91=l9_64.x;
sc_SoftwareWrapEarly(l9_91,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N10,SC_SOFTWARE_WRAP_MODE_V_Tweak_N10).x);
float l9_92=l9_91;
float l9_93=l9_64.y;
sc_SoftwareWrapEarly(l9_93,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N10,SC_SOFTWARE_WRAP_MODE_V_Tweak_N10).y);
float l9_94=l9_93;
vec2 l9_95;
float l9_96;
#if (SC_USE_UV_MIN_MAX_Tweak_N10)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N10)
{
l9_97=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N10,SC_SOFTWARE_WRAP_MODE_V_Tweak_N10).x==3;
}
#else
{
l9_97=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N10)!=0);
}
#endif
float l9_98=l9_92;
float l9_99=1.0;
sc_ClampUV(l9_98,Tweak_N10UvMinMax.x,Tweak_N10UvMinMax.z,l9_97,l9_99);
float l9_100=l9_98;
float l9_101=l9_99;
bool l9_102;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N10)
{
l9_102=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N10,SC_SOFTWARE_WRAP_MODE_V_Tweak_N10).y==3;
}
#else
{
l9_102=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N10)!=0);
}
#endif
float l9_103=l9_94;
float l9_104=l9_101;
sc_ClampUV(l9_103,Tweak_N10UvMinMax.y,Tweak_N10UvMinMax.w,l9_102,l9_104);
l9_96=l9_104;
...
#endif
vec2 l9_105=sc_TransformUV(l9_95,(int(SC_USE_UV_TRANSFORM_Tweak_N10)!=0),Tweak_N10Transform);
float l9_106=l9_105.x;
float l9_107=l9_96;
sc_SoftwareWrapLate(l9_106,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N10,SC_SOFTWARE_WRAP_MODE_V_Tweak_N10).x,l9_90,l9_107);
float l9_108=l9_105.y;
float l9_109=l9_107;
sc_SoftwareWrapLate(l9_108,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N10,SC_SOFTWARE_WRAP_MODE_V_Tweak_N10).y,l9_90,l9_109);
float l9_110=l9_109;
vec3 l9_111=sc_SamplingCoordsViewToGlobal(vec2(l9_106,l9_108),Tweak_N10Layout,Tweak_N10GetStereoViewIndex());
vec4 l9_112=texture(Tweak_N10,l9_111.xy,0.0);
vec4 l9_113;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N10)
{
l9_113=mix(Tweak_N10BorderColor,l9_112,vec4(l9_110));
}
#else
{
l9_113=l9_112;
...
#endif
vec4 l9_114=mix(YellowColor,WhiteColor,vec4(l9_65.x));
float l9_115=distance(l9_1,Port_Input1_N013);
float l9_116=((smoothstep(Port_Input0_N016,Port_Input1_N016,l9_115)-smoothstep(Port_Input0_N015,Port_Input1_N015,l9_115))+Port_Input1_N018)+l9_65.x;
vec4 l9_117=vec4(l9_114.x,l9_114.y,l9_114.z,vec4(0.0).w);
l9_117.w=l9_116;
...
#endif
sc_writeFragData0(max(l9_118,vec4(0.0)));
return;
}
vec4 l9_120;
...
{
l9_122=clamp(l9_116*2.0,0.0,1.0);
}
#else
{
float l9_123;
...
{
l9_123=clamp(dot(l9_117.xyz,vec3(l9_116)),0.0,1.0);
}
#else
{
float l9_124;
...
{
l9_125=(1.0-dot(l9_117.xyz,vec3(0.33333001)))*l9_116;
}
#else
{
float l9_126;
...
{
l9_126=(1.0-clamp(dot(l9_117.xyz,vec3(1.0)),0.0,1.0))*l9_116;
}
#else
{
float l9_127;
...
{
l9_127=clamp(dot(l9_117.xyz,vec3(1.0)),0.0,1.0)*l9_116;
}
#else
{
float l9_128;
#if (sc_BlendMode_Add)
{
l9_128=clamp(dot(l9_117.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_129;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_129=clamp(dot(l9_117.xyz,vec3(1.0)),0.0,1.0)*l9_116;
}
#else
{
float l9_130;
...
{
l9_130=dot(l9_117.xyz,vec3(0.33333001))*l9_116;
}
#else
{
float l9_131;
#if (sc_BlendMode_Min)
{
l9_131=1.0-clamp(dot(l9_117.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_132;
#if (sc_BlendMode_Max)
{
l9_132=clamp(dot(l9_117.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_132=1.0;
...
#endif
l9_120=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_117.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_121);
}
#else
{
vec4 l9_133;
...
{
l9_137=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_136,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_137=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_136,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_135=l9_137;
}
#endif
vec3 l9_138=mix(l9_135.xyz,definedBlend(l9_135.xyz,l9_117.xyz).xyz,vec3(l9_116));
...
#if (sc_Voxelization)
{
l9_140=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_141;
#if (sc_OutputBounds)
{
float l9_142=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_141=vec4(l9_142,1.0-l9_142,1.0,1.0);
}
#else
{
vec4 l9_143;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_143=vec4(mix(vec3(1.0),l9_117.xyz,vec3(l9_116)),l9_116);
}
#else
{
vec4 l9_144;
...
#endif
l9_144=vec4(l9_117.xyz*l9_145,l9_145);
}
#else
{
l9_144=l9_117;
...
vec4 l9_148=sc_OutputMotionVectorIfNeeded(max(l9_146,vec4(0.0)));
