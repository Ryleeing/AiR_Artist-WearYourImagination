...
//sampler sampler cubemapSmpSC 0:16
...
//texture textureCube cubemap 0:0:0:16
...
//texture texture2DArray intensityTextureArrSC 0:25:0:17
//texture texture2DArray sc_ScreenTextureArrSC 0:28:0:22
...
uniform float Port_Input0_N030;
...
float l9_8=step(varColor.z,Port_Input1_N012);
float l9_9=length(sc_ModelMatrix[0].xyz);
float l9_10=l9_9-max(Port_Input0_N023-l9_9,Port_Input1_N032);
float l9_11=max(length(sc_ModelMatrix[1].xyz),length(sc_ModelMatrix[2].xyz));
float l9_12=Port_Input0_N030/(l9_11+1.234e-06);
float l9_13=step(varColor.x,Port_Input1_N016);
vec3 l9_14;
vec3 l9_15;
vec3 l9_16;
if (l9_4)
...
l9_15=varNormalAndMotion.xyz;
l9_14=varPosAndMotion.xyz;
}
else
{
l9_16=varTangent.xyz;
l9_15=varNormalAndMotion.xyz;
l9_14=(sc_ModelMatrix*vec4((((((l9_7.x+(l9_8*Port_Input1_N013))+((l9_8*l9_10)*(l9_12*Port_Input1_N031)))+(l9_13*Port_Input1_N015))+((l9_13*l9_10)*l9_12))/(l9_9+1.234e-06))*l9_11,l9_7.yz,1.0)).xyz;
}
varPosAndMotion=vec4(l9_14.x,l9_14.y,l9_14.z,varPosAndMotion.w);
vec3 l9_17=normalize(l9_15);
varNormalAndMotion=vec4(l9_17.x,l9_17.y,l9_17.z,varNormalAndMotion.w);
vec3 l9_18=normalize(l9_16);
varTangent=vec4(l9_18.x,l9_18.y,l9_18.z,varTangent.w);
...
#if (sc_RenderingSpace==3)
{
l9_19=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_0.position;
}
#else
{
vec4 l9_20;
#if (sc_RenderingSpace==2)
{
l9_20=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_0.position;
}
#else
{
vec4 l9_21;
#if (sc_RenderingSpace==1)
{
l9_21=sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_0.position;
}
#else
{
l9_21=l9_0.position;
...
#if (sc_RenderingSpace==4)
{
l9_23=(sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_0.position)*vec4(1.0/sc_Camera.aspect,1.0,1.0,1.0);
}
#else
{
vec4 l9_24;
...
#if (sc_RenderingSpace==1)
{
l9_26=sc_ModelMatrix*l9_0.position;
}
#else
{
l9_26=l9_0.position;
...
#endif
vec4 l9_27=sc_ProjectorMatrix*l9_26;
varShadowTex=((l9_27.xy/vec2(l9_27.w))*0.5)+vec2(0.5);
}
#endif
vec4 l9_28;
...
{
vec4 l9_30=l9_22;
l9_30.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_22.w))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_22.w;
l9_29=l9_30;
}
else
{
...
#if (sc_TAAEnabled)
{
vec2 l9_32=l9_28.xy+(sc_TAAJitterOffset*l9_28.w);
l9_31=vec4(l9_32.x,l9_32.y,l9_28.z,l9_28.w);
}
#else
{
l9_31=l9_28;
...
#endif
sc_SetClipPosition(l9_31);
#if (sc_Voxelization)
{
sc_Vertex_t l9_33=sc_Vertex_t(l9_0.position,l9_0.normal,l9_0.tangent,l9_5,l9_0.texture1);
sc_BlendVertex(l9_33);
sc_SkinVertex(l9_33);
int l9_34=sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID);
int l9_35=int(voxelization_params_0.w);
vec4 l9_36=createVoxelOrthoMatrix(voxelization_params_frustum_lrbt.x,voxelization_params_frustum_lrbt.y,voxelization_params_frustum_lrbt.z,voxelization_params_frustum_lrbt.w,voxelization_params_frustum_nf.x,voxelization_params_frustum_nf.y)*vec4(((sc_ModelMatrixVoxelization*l9_33.position).xyz+vec3(float(l9_34%l9_35)*voxelization_params_0.y,float(l9_34/l9_35)*voxelization_params_0.y,(float(l9_34)*(voxelization_params_0.y/voxelization_params_0.z))+voxelization_params_frustum_nf.x))-voxelization_params_camera_pos,1.0);
l9_36.w=1.0;
varScreenPos=l9_36;
...
#if (sc_OutputBounds)
{
sc_Vertex_t l9_37=sc_Vertex_t(l9_0.position,l9_0.normal,l9_0.tangent,l9_5,l9_0.texture1);
sc_BlendVertex(l9_37);
sc_SkinVertex(l9_37);
vec2 l9_38=((l9_37.position.xy/vec2(l9_37.position.w))*0.5)+vec2(0.5);
varTex01=vec4(l9_38.x,l9_38.y,varTex01.z,varTex01.w);
vec4 l9_39=sc_ModelMatrixVoxelization*l9_37.position;
vec3 l9_40=l9_39.xyz-voxelization_params_camera_pos;
varPosAndMotion=vec4(l9_40.x,l9_40.y,l9_40.z,varPosAndMotion.w);
vec3 l9_41=normalize(l9_37.normal);
varNormalAndMotion=vec4(l9_41.x,l9_41.y,l9_41.z,varNormalAndMotion.w);
vec4 l9_42=createVoxelOrthoMatrix(voxelization_params_frustum_lrbt.x,voxelization_params_frustum_lrbt.y,voxelization_params_frustum_lrbt.z,voxelization_params_frustum_lrbt.w,voxelization_params_frustum_nf.x,voxelization_params_frustum_nf.y)*vec4(l9_40.x,l9_40.y,l9_40.z,l9_39.w);
vec4 l9_43=vec4(l9_42.x,l9_42.y,l9_42.z,vec4(0.0).w);
l9_43.w=1.0;
varScreenPos=l9_43;
sc_SetClipPosition(l9_43*1.0);
}
#endif
}
#endif
vec4 l9_44=varPosAndMotion;
#if (sc_MotionVectorsPass)
{
vec4 l9_45=vec4(l9_44.xyz,1.0);
#if (sc_MotionVectorsPass)
{
vec4 l9_46=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*l9_45;
vec4 l9_47=sc_PrevFrameViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(((sc_PrevFrameModelMatrix*sc_ModelMatrixInverse)*l9_45).xyz,1.0);
vec2 l9_48=((l9_46.xy/vec2(l9_46.w)).xy-(l9_47.xy/vec2(l9_47.w)).xy)*0.5;
varPosAndMotion.w=l9_48.x;
varNormalAndMotion.w=l9_48.y;
}
#endif
}
#endif
...
float l9_1=l9_0.y;
float l9_2=(Port_Value_N050+0.001)-0.001;
vec4 l9_3=texture(cubemap,reflect(vec3((-normalize(sc_Camera.position-varPosAndMotion.xyz)).xzy)*Port_Input1_N037,normalize(varNormalAndMotion.xyz)),0.0);
vec4 l9_4=clamp(((vec4(min(smoothstep(Port_Input0_N046,Port_Input1_N046,l9_1)*l9_2,l9_2))+baseColor)+((l9_3*vec4(clamp((Port_Input0_N052+smoothstep(Port_Input0_N057,Port_Input1_N057,l9_0.x+l9_1))+0.001,Port_Input1_N056+0.001,Port_Input2_N056+0.001)-0.001))*vec4(Port_Input1_N051)))+vec4(0.001),Port_Input1_N042+vec4(0.001),Port_Input2_N042+vec4(0.001))-vec4(0.001);
float l9_5=l9_4.w;
...
{
l9_9=clamp(dot(l9_4.xyz,vec3(l9_5)),0.0,1.0);
}
#else
{
float l9_10;
...
{
l9_11=(1.0-dot(l9_4.xyz,vec3(0.33333001)))*l9_5;
}
#else
{
float l9_12;
...
{
l9_12=(1.0-clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0))*l9_5;
}
#else
{
float l9_13;
...
{
l9_13=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0)*l9_5;
}
#else
{
float l9_14;
#if (sc_BlendMode_Add)
{
l9_14=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_15;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_15=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0)*l9_5;
}
#else
{
float l9_16;
...
{
l9_16=dot(l9_4.xyz,vec3(0.33333001))*l9_5;
}
#else
{
float l9_17;
#if (sc_BlendMode_Min)
{
l9_17=1.0-clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_18;
#if (sc_BlendMode_Max)
{
l9_18=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_18=1.0;
...
#endif
l9_6=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_4.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_7);
}
#else
{
vec4 l9_19;
...
#endif
vec3 l9_24=mix(l9_21.xyz,definedBlend(l9_21.xyz,l9_4.xyz).xyz,vec3(l9_5));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_29=vec4(mix(vec3(1.0),l9_4.xyz,vec3(l9_5)),l9_5);
}
#else
{
vec4 l9_30;
...
#endif
l9_30=vec4(l9_4.xyz*l9_31,l9_31);
}
#else
{
l9_30=l9_4;
