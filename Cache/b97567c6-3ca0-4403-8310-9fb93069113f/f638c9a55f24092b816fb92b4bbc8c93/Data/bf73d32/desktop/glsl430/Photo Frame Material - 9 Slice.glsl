...
float l9_3=length(sc_ModelMatrix[0].xyz);
float l9_4=length(sc_ModelMatrix[1].xyz);
float l9_5=min(min(clamp(borderScale,0.0,1.0),l9_3/2.0),l9_4/2.0);
float l9_6=(baseTexSize.x/baseTexSize.y)*l9_5;
float l9_7=((sliceSizeLeft*l9_6)*2.0)/l9_3;
float l9_8=1.0-(((sliceSizeRight*l9_6)*2.0)/l9_3);
float l9_9=((sliceSizeBottom*l9_5)*2.0)/l9_4;
float l9_10=1.0-(((sliceSizeTop*l9_5)*2.0)/l9_4);
float l9_11=1.0-sliceSizeRight;
float l9_12=1.0-sliceSizeTop;
float l9_13;
if (l9_1.x<l9_7)
{
l9_13=0.0+(((l9_1.x-0.0)*(sliceSizeLeft-0.0))/((l9_7-0.0)+1e-06));
}
else
{
l9_13=(l9_1.x<l9_8) ? (sliceSizeLeft+(((l9_1.x-l9_7)*(l9_11-sliceSizeLeft))/((l9_8-l9_7)+1e-06))) : (l9_11+(((l9_1.x-l9_8)*(1.0-l9_11))/((1.0-l9_8)+1e-06)));
}
float l9_14;
if (l9_1.y<l9_9)
{
l9_14=0.0+(((l9_1.y-0.0)*(sliceSizeBottom-0.0))/((l9_9-0.0)+1e-06));
}
else
{
l9_14=(l9_1.y<l9_10) ? (sliceSizeBottom+(((l9_1.y-l9_9)*(l9_12-sliceSizeBottom))/((l9_10-l9_9)+1e-06))) : (l9_12+(((l9_1.y-l9_10)*(1.0-l9_12))/((1.0-l9_10)+1e-06)));
}
vec4 l9_15;
#if (baseTexLayout==2)
{
...
{
if (l9_15.w<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_68=clamp(l9_15.w*2.0,0.0,1.0);
}
#else
{
float l9_69;
...
{
l9_69=clamp(dot(l9_15.xyz,vec3(l9_15.w)),0.0,1.0);
}
#else
{
float l9_70;
...
{
l9_71=(1.0-dot(l9_15.xyz,vec3(0.33333001)))*l9_15.w;
}
#else
{
float l9_72;
...
{
l9_72=(1.0-clamp(dot(l9_15.xyz,vec3(1.0)),0.0,1.0))*l9_15.w;
}
#else
{
float l9_73;
...
{
l9_73=clamp(dot(l9_15.xyz,vec3(1.0)),0.0,1.0)*l9_15.w;
}
#else
{
float l9_74;
#if (sc_BlendMode_Add)
{
l9_74=clamp(dot(l9_15.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_75;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_75=clamp(dot(l9_15.xyz,vec3(1.0)),0.0,1.0)*l9_15.w;
}
#else
{
float l9_76;
...
{
l9_76=dot(l9_15.xyz,vec3(0.33333001))*l9_15.w;
}
#else
{
float l9_77;
#if (sc_BlendMode_Min)
{
l9_77=1.0-clamp(dot(l9_15.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_78;
#if (sc_BlendMode_Max)
{
l9_78=clamp(dot(l9_15.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_78=1.0;
...
#endif
l9_66=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_15.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_67);
}
#else
{
vec4 l9_79;
...
#endif
vec3 l9_84=mix(l9_81.xyz,definedBlend(l9_81.xyz,l9_15.xyz).xyz,vec3(l9_15.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_89=vec4(mix(vec3(1.0),l9_15.xyz,vec3(l9_15.w)),l9_15.w);
}
#else
{
vec4 l9_90;
...
#endif
l9_90=vec4(l9_15.xyz*l9_91,l9_91);
}
#else
{
l9_90=l9_15;
