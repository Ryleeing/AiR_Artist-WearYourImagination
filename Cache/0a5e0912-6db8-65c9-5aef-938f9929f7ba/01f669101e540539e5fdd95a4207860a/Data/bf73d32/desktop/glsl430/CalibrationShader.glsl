...
//sampler sampler IconTexSmpSC 0:21
...
//texture texture2D IconTex 0:3:0:21
...
//texture texture2DArray IconTexArrSC 0:32:0:21
...
//spec_const int IconTexLayout 76 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_IconTex 77 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 78 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_IconTex 79 -1
...
uniform sampler2DArray IconTexArrSC;
...
vec2 l9_4;
Node14_Rotate_Coords(l9_1,Port_Rotation_N014,Port_Center_N014,l9_4,l9_3);
vec2 l9_5=l9_4;
...
{
vec2 l9_13;
Node14_Rotate_Coords(l9_1,Port_Rotation_N014,Port_Center_N014,l9_13,l9_3);
vec2 l9_14=l9_13;
...
if (l9_25)
{
l9_26=(float(atan(l9_17,l9_16)<=((((Amount-Port_RangeMinA_N010)/((Port_RangeMaxA_N010-Port_RangeMinA_N010)+1e-06))*(Port_RangeMaxB_N010-Port_RangeMinB_N010))+Port_RangeMinB_N010))*1.0)!=0.0;
}
else
{
l9_26=l9_25;
...
vec2 param_4;
Node14_Rotate_Coords(l9_1,Port_Rotation_N014,Port_Center_N014,param_4,l9_3);
vec2 l9_28=param_4;
...
{
vec2 l9_40=l9_1-Port_Center_N026;
vec2 l9_41=(l9_40*vec2((((CurrSize-StartSize)/((Port_RangeMaxA_N029-StartSize)+1e-06))*(Port_RangeMaxB_N029-Port_RangeMinB_N029))+Port_RangeMinB_N029))+Port_Center_N026;
vec4 l9_42;
#if (IconTexLayout==2)
{
bool l9_43=(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_IconTex)!=0));
float l9_44=l9_41.x;
sc_SoftwareWrapEarly(l9_44,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x);
float l9_45=l9_44;
float l9_46=l9_41.y;
sc_SoftwareWrapEarly(l9_46,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y);
float l9_47=l9_46;
vec2 l9_48;
float l9_49;
#if (SC_USE_UV_MIN_MAX_IconTex)
{
bool l9_50;
#if (SC_USE_CLAMP_TO_BORDER_IconTex)
{
l9_50=ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x==3;
}
#else
{
l9_50=(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0);
}
#endif
float l9_51=l9_45;
float l9_52=1.0;
sc_ClampUV(l9_51,IconTexUvMinMax.x,IconTexUvMinMax.z,l9_50,l9_52);
float l9_53=l9_51;
float l9_54=l9_52;
bool l9_55;
#if (SC_USE_CLAMP_TO_BORDER_IconTex)
{
l9_55=ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y==3;
}
#else
{
l9_55=(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0);
}
#endif
float l9_56=l9_47;
float l9_57=l9_54;
sc_ClampUV(l9_56,IconTexUvMinMax.y,IconTexUvMinMax.w,l9_55,l9_57);
l9_49=l9_57;
...
#endif
vec2 l9_58=sc_TransformUV(l9_48,(int(SC_USE_UV_TRANSFORM_IconTex)!=0),IconTexTransform);
float l9_59=l9_58.x;
float l9_60=l9_49;
sc_SoftwareWrapLate(l9_59,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x,l9_43,l9_60);
float l9_61=l9_58.y;
float l9_62=l9_60;
sc_SoftwareWrapLate(l9_61,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y,l9_43,l9_62);
float l9_63=l9_62;
vec3 l9_64=sc_SamplingCoordsViewToGlobal(vec2(l9_59,l9_61),IconTexLayout,IconTexGetStereoViewIndex());
vec4 l9_65=texture(IconTexArrSC,l9_64,0.0);
vec4 l9_66;
#if (SC_USE_CLAMP_TO_BORDER_IconTex)
{
l9_66=mix(IconTexBorderColor,l9_65,vec4(l9_63));
}
#else
{
l9_66=l9_65;
...
#else
{
bool l9_67=(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_IconTex)!=0));
float l9_68=l9_41.x;
sc_SoftwareWrapEarly(l9_68,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x);
float l9_69=l9_68;
float l9_70=l9_41.y;
sc_SoftwareWrapEarly(l9_70,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y);
float l9_71=l9_70;
vec2 l9_72;
float l9_73;
#if (SC_USE_UV_MIN_MAX_IconTex)
...
#if (SC_USE_CLAMP_TO_BORDER_IconTex)
{
l9_74=ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x==3;
}
#else
{
l9_74=(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0);
}
#endif
float l9_75=l9_69;
float l9_76=1.0;
sc_ClampUV(l9_75,IconTexUvMinMax.x,IconTexUvMinMax.z,l9_74,l9_76);
float l9_77=l9_75;
float l9_78=l9_76;
bool l9_79;
#if (SC_USE_CLAMP_TO_BORDER_IconTex)
{
l9_79=ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y==3;
}
#else
{
l9_79=(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0);
}
#endif
float l9_80=l9_71;
float l9_81=l9_78;
sc_ClampUV(l9_80,IconTexUvMinMax.y,IconTexUvMinMax.w,l9_79,l9_81);
l9_73=l9_81;
...
#endif
vec2 l9_82=sc_TransformUV(l9_72,(int(SC_USE_UV_TRANSFORM_IconTex)!=0),IconTexTransform);
float l9_83=l9_82.x;
float l9_84=l9_73;
sc_SoftwareWrapLate(l9_83,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x,l9_67,l9_84);
float l9_85=l9_82.y;
float l9_86=l9_84;
sc_SoftwareWrapLate(l9_85,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y,l9_67,l9_86);
float l9_87=l9_86;
vec3 l9_88=sc_SamplingCoordsViewToGlobal(vec2(l9_83,l9_85),IconTexLayout,IconTexGetStereoViewIndex());
vec4 l9_89=texture(IconTex,l9_88.xy,0.0);
vec4 l9_90;
#if (SC_USE_CLAMP_TO_BORDER_IconTex)
{
l9_90=mix(IconTexBorderColor,l9_89,vec4(l9_87));
}
#else
{
l9_90=l9_89;
...
{
vec2 l9_91=l9_1-Port_Center_N026;
vec2 l9_92=(l9_91*vec2((((CurrSize-StartSize)/((Port_RangeMaxA_N029-StartSize)+1e-06))*(Port_RangeMaxB_N029-Port_RangeMinB_N029))+Port_RangeMinB_N029))+Port_Center_N026;
vec4 l9_93;
#if (IconTexLayout==2)
{
bool l9_94=(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_IconTex)!=0));
float l9_95=l9_92.x;
sc_SoftwareWrapEarly(l9_95,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x);
float l9_96=l9_95;
float l9_97=l9_92.y;
sc_SoftwareWrapEarly(l9_97,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y);
float l9_98=l9_97;
vec2 l9_99;
float l9_100;
#if (SC_USE_UV_MIN_MAX_IconTex)
...
#if (SC_USE_CLAMP_TO_BORDER_IconTex)
{
l9_101=ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x==3;
}
#else
{
l9_101=(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0);
}
#endif
float l9_102=l9_96;
float l9_103=1.0;
sc_ClampUV(l9_102,IconTexUvMinMax.x,IconTexUvMinMax.z,l9_101,l9_103);
float l9_104=l9_102;
float l9_105=l9_103;
bool l9_106;
#if (SC_USE_CLAMP_TO_BORDER_IconTex)
{
l9_106=ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y==3;
}
#else
{
l9_106=(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0);
}
#endif
float l9_107=l9_98;
float l9_108=l9_105;
sc_ClampUV(l9_107,IconTexUvMinMax.y,IconTexUvMinMax.w,l9_106,l9_108);
l9_100=l9_108;
...
#endif
vec2 l9_109=sc_TransformUV(l9_99,(int(SC_USE_UV_TRANSFORM_IconTex)!=0),IconTexTransform);
float l9_110=l9_109.x;
float l9_111=l9_100;
sc_SoftwareWrapLate(l9_110,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x,l9_94,l9_111);
float l9_112=l9_109.y;
float l9_113=l9_111;
sc_SoftwareWrapLate(l9_112,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y,l9_94,l9_113);
float l9_114=l9_113;
vec3 l9_115=sc_SamplingCoordsViewToGlobal(vec2(l9_110,l9_112),IconTexLayout,IconTexGetStereoViewIndex());
vec4 l9_116=texture(IconTexArrSC,l9_115,0.0);
vec4 l9_117;
#if (SC_USE_CLAMP_TO_BORDER_IconTex)
{
l9_117=mix(IconTexBorderColor,l9_116,vec4(l9_114));
}
#else
{
l9_117=l9_116;
...
#else
{
bool l9_118=(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_IconTex)!=0));
float l9_119=l9_92.x;
sc_SoftwareWrapEarly(l9_119,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x);
float l9_120=l9_119;
float l9_121=l9_92.y;
sc_SoftwareWrapEarly(l9_121,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y);
float l9_122=l9_121;
vec2 l9_123;
float l9_124;
#if (SC_USE_UV_MIN_MAX_IconTex)
...
#if (SC_USE_CLAMP_TO_BORDER_IconTex)
{
l9_125=ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x==3;
}
#else
{
l9_125=(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0);
}
#endif
float l9_126=l9_120;
float l9_127=1.0;
sc_ClampUV(l9_126,IconTexUvMinMax.x,IconTexUvMinMax.z,l9_125,l9_127);
float l9_128=l9_126;
float l9_129=l9_127;
bool l9_130;
#if (SC_USE_CLAMP_TO_BORDER_IconTex)
{
l9_130=ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y==3;
}
#else
{
l9_130=(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0);
}
#endif
float l9_131=l9_122;
float l9_132=l9_129;
sc_ClampUV(l9_131,IconTexUvMinMax.y,IconTexUvMinMax.w,l9_130,l9_132);
l9_124=l9_132;
...
#endif
vec2 l9_133=sc_TransformUV(l9_123,(int(SC_USE_UV_TRANSFORM_IconTex)!=0),IconTexTransform);
float l9_134=l9_133.x;
float l9_135=l9_124;
sc_SoftwareWrapLate(l9_134,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x,l9_118,l9_135);
float l9_136=l9_133.y;
float l9_137=l9_135;
sc_SoftwareWrapLate(l9_136,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y,l9_118,l9_137);
float l9_138=l9_137;
vec3 l9_139=sc_SamplingCoordsViewToGlobal(vec2(l9_134,l9_136),IconTexLayout,IconTexGetStereoViewIndex());
vec4 l9_140=texture(IconTex,l9_139.xy,0.0);
vec4 l9_141;
#if (SC_USE_CLAMP_TO_BORDER_IconTex)
{
l9_141=mix(IconTexBorderColor,l9_140,vec4(l9_138));
}
#else
{
l9_141=l9_140;
...
#endif
l9_39=(vec2(l9_93.w)*vec2((((CurrSize-Port_RangeMinA_N032)/((StartSize-Port_RangeMinA_N032)+1e-06))*(Port_RangeMaxB_N032-Port_RangeMinB_N032))+Port_RangeMinB_N032)).x;
}
float l9_142=(1.0-l9_38)+l9_39;
vec4 l9_143=vec4(l9_12.x,l9_12.y,l9_12.z,vec4(0.0).w);
l9_143.w=l9_142;
#if (sc_BlendMode_AlphaTest)
{
if (l9_142<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_142<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_148=clamp(l9_142*2.0,0.0,1.0);
}
#else
{
float l9_149;
...
{
l9_149=clamp(dot(l9_143.xyz,vec3(l9_142)),0.0,1.0);
}
#else
{
float l9_150;
...
{
l9_151=(1.0-dot(l9_143.xyz,vec3(0.33333001)))*l9_142;
}
#else
{
float l9_152;
...
{
l9_152=(1.0-clamp(dot(l9_143.xyz,vec3(1.0)),0.0,1.0))*l9_142;
}
#else
{
float l9_153;
...
{
l9_153=clamp(dot(l9_143.xyz,vec3(1.0)),0.0,1.0)*l9_142;
}
#else
{
float l9_154;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_155=clamp(dot(l9_143.xyz,vec3(1.0)),0.0,1.0)*l9_142;
}
#else
{
float l9_156;
...
{
l9_156=dot(l9_143.xyz,vec3(0.33333001))*l9_142;
}
#else
{
float l9_157;
...
{
l9_163=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_162,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_163=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_162,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_161=l9_163;
}
#endif
vec3 l9_164=mix(l9_161.xyz,definedBlend(l9_161.xyz,l9_143.xyz).xyz,vec3(l9_142));
vec4 l9_165=vec4(l9_164.x,l9_164.y,l9_164.z,vec4(0.0).w);
l9_165.w=1.0;
l9_160=l9_165;
}
#else
...
#if (sc_Voxelization)
{
l9_166=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_167;
#if (sc_OutputBounds)
{
float l9_168=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_167=vec4(l9_168,1.0-l9_168,1.0,1.0);
}
#else
{
vec4 l9_169;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_169=vec4(mix(vec3(1.0),l9_143.xyz,vec3(l9_142)),l9_142);
}
#else
{
vec4 l9_170;
...
#endif
l9_170=vec4(l9_143.xyz*l9_171,l9_171);
}
#else
{
l9_170=l9_143;
...
vec4 l9_174=sc_OutputMotionVectorIfNeeded(max(l9_172,vec4(0.0)));
vec4 l9_175=clamp(l9_174,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_176=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_176-0.0039215689)),min(1.0,l9_176+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#endif
int l9_178=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_177).xy);
float l9_179=packValue(l9_178);
int l9_186=int(l9_175.w*255.0);
float l9_187=packValue(l9_186);
sc_writeFragData0(vec4(packValue(l9_178),packValue(l9_178),packValue(l9_178),packValue(l9_178)));
}
#endif
}
#else
...
if (l9_195==0)
{
l9_198=texture(sc_OITAlpha0,l9_190);
l9_197=texture(sc_OITDepthLow0,l9_190);
l9_196=texture(sc_OITDepthHigh0,l9_190);
}
else
{
l9_198=vec4(0.0);
...
if (l9_195==1)
{
l9_201=texture(sc_OITAlpha1,l9_190);
l9_200=texture(sc_OITDepthLow1,l9_190);
l9_199=texture(sc_OITDepthHigh1,l9_190);
}
else
{
l9_201=l9_198;
...
if (any(notEqual(l9_199,vec4(0.0)))||any(notEqual(l9_200,vec4(0.0))))
{
int l9_202[8]=l9_191;
unpackValues(l9_199.w,l9_195,l9_202);
unpackValues(l9_199.z,l9_195,l9_202);
unpackValues(l9_199.y,l9_195,l9_202);
unpackValues(l9_199.x,l9_195,l9_202);
unpackValues(l9_200.w,l9_195,l9_202);
unpackValues(l9_200.z,l9_195,l9_202);
unpackValues(l9_200.y,l9_195,l9_202);
unpackValues(l9_200.x,l9_195,l9_202);
int l9_211[8]=l9_192;
unpackValues(l9_201.w,l9_195,l9_211);
unpackValues(l9_201.z,l9_195,l9_211);
unpackValues(l9_201.y,l9_195,l9_211);
unpackValues(l9_201.x,l9_195,l9_211);
}
l9_195++;
continue;
}
...
vec4 l9_216=texture(sc_OITFilteredDepthBoundsTexture,l9_190);
vec2 l9_217=l9_216.xy;
int l9_218;
#if (sc_SkinBonesCount>0)
{
l9_218=encodeDepth(((1.0-l9_216.x)*1000.0)+getDepthOrderingEpsilon(),l9_217);
}
#else
{
l9_218=0;
...
#endif
int l9_219=encodeDepth(viewSpaceDepth(),l9_217);
vec4 l9_220;
l9_220=l9_175*l9_175.w;
vec4 l9_221;
int l9_222=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_222<8)
{
int l9_223=l9_191[l9_222];
int l9_224=l9_219-l9_218;
bool l9_225=l9_223<l9_224;
bool l9_226;
if (l9_225)
{
l9_226=l9_191[l9_222]>0;
}
else
{
l9_226=l9_225;
...
if (l9_226)
{
vec3 l9_227=l9_220.xyz*(1.0-(float(l9_192[l9_222])/255.0));
l9_221=vec4(l9_227.x,l9_227.y,l9_227.z,l9_220.w);
}
else
{
l9_221=l9_220;
