...
uniform float Port_Position3_N021;
uniform float Port_Position4_N021;
...
uniform float Port_Rotation_N000;
uniform vec2 Port_Center_N000;
uniform float Port_Position1_N136;
uniform float Port_Position2_N136;
uniform float Port_Position3_N136;
uniform float Port_Position4_N136;
...
void Node70_Normalize(vec3 Input0,out vec3 Output,ssGlobals Globals)
{
vec3 l9_0=Input0;
vec3 l9_1=Input0;
...
void Node7_Gradient(float Ratio,vec4 Value0,float Position1,vec4 Value1,float Position2,vec4 Value2,vec4 Value3,out vec4 Value,ssGlobals Globals)
{
...
{
Value=mix(Value2,Value3,vec4(clamp((Ratio-Position2)/(1.0-Position2),0.0,1.0)));
}
}
}
void Node18_Gradient(float Ratio,float Value0,float Position1,float Value1,float Position2,float Value2,float Position3,float Value3,float Value4,out float Value,ssGlobals Globals)
{
Ratio=clamp(Ratio,0.0,1.0);
if (Ratio<Position1)
{
...
void Node31_Rim(vec3 Normal,float Exponent,float Intensity,out float Rim,ssGlobals Globals)
{
...
void Node14_Gradient(float Ratio,vec4 Value0,float Position1,vec4 Value1,float Position2,vec4 Value2,vec4 Value3,out vec4 Value,ssGlobals Globals)
{
Ratio=clamp(Ratio,0.0,1.0);
if (Ratio<Position1)
{
...
void Node21_Gradient(float Ratio,vec4 Value0,float Position1,vec4 Value1,float Position2,vec4 Value2,float Position3,vec4 Value3,float Position4,vec4 Value4,vec4 Value5,out vec4 Value,ssGlobals Globals)
{
Ratio=clamp(Ratio,0.0,1.0);
if (Ratio<Position1)
{
...
void Node16_If_else(float Bool1,vec4 Value1,vec4 Default,out vec4 Result,ssGlobals Globals)
{
Bool1=float(float(hasIcon)==Port_Input1_N017);
if ((Bool1*1.0)!=0.0)
{
vec3 param_1;
Node70_Normalize(mat3(Globals.VertexTangent_WorldSpace,Globals.VertexBinormal_WorldSpace,Globals.VertexNormal_WorldSpace)*Port_Import_N068,param_1,Globals);
vec3 l9_0=((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(param_1,0.0)).xyz*vec3(Port_Input1_N073))+vec3(Port_Input2_N073);
vec4 l9_1;
#if (additional_settings_btn_refl_texLayout==2)
{
bool l9_2=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0));
float l9_3=l9_0.x;
sc_SoftwareWrapEarly(l9_3,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x);
float l9_4=l9_3;
float l9_5=l9_0.y;
sc_SoftwareWrapEarly(l9_5,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y);
float l9_6=l9_5;
vec2 l9_7;
float l9_8;
...
{
l9_9=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x==3;
}
#else
{
l9_9=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_10=l9_4;
float l9_11=1.0;
sc_ClampUV(l9_10,additional_settings_btn_refl_texUvMinMax.x,additional_settings_btn_refl_texUvMinMax.z,l9_9,l9_11);
float l9_12=l9_10;
float l9_13=l9_11;
bool l9_14;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_14=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y==3;
}
#else
{
...
float l9_15=l9_6;
float l9_16=l9_13;
sc_ClampUV(l9_15,additional_settings_btn_refl_texUvMinMax.y,additional_settings_btn_refl_texUvMinMax.w,l9_14,l9_16);
l9_8=l9_16;
...
#endif
vec2 l9_17=sc_TransformUV(l9_7,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform);
float l9_18=l9_17.x;
float l9_19=l9_8;
sc_SoftwareWrapLate(l9_18,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x,l9_2,l9_19);
float l9_20=l9_17.y;
float l9_21=l9_19;
sc_SoftwareWrapLate(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y,l9_2,l9_21);
float l9_22=l9_21;
vec3 l9_23=sc_SamplingCoordsViewToGlobal(vec2(l9_18,l9_20),additional_settings_btn_refl_texLayout,additional_settings_btn_refl_texGetStereoViewIndex());
vec4 l9_24=texture(additional_settings_btn_refl_texArrSC,l9_23,0.0);
vec4 l9_25;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_25=mix(additional_settings_btn_refl_texBorderColor,l9_24,vec4(l9_22));
}
#else
{
l9_25=l9_24;
...
#else
{
bool l9_26=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0));
float l9_27=l9_0.x;
sc_SoftwareWrapEarly(l9_27,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x);
float l9_28=l9_27;
float l9_29=l9_0.y;
sc_SoftwareWrapEarly(l9_29,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y);
float l9_30=l9_29;
vec2 l9_31;
float l9_32;
#if (SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)
...
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_33=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x==3;
}
#else
{
...
float l9_34=l9_28;
float l9_35=1.0;
sc_ClampUV(l9_34,additional_settings_btn_refl_texUvMinMax.x,additional_settings_btn_refl_texUvMinMax.z,l9_33,l9_35);
float l9_36=l9_34;
float l9_37=l9_35;
bool l9_38;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_38=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y==3;
}
#else
{
l9_38=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_39=l9_30;
float l9_40=l9_37;
sc_ClampUV(l9_39,additional_settings_btn_refl_texUvMinMax.y,additional_settings_btn_refl_texUvMinMax.w,l9_38,l9_40);
l9_32=l9_40;
...
#endif
vec2 l9_41=sc_TransformUV(l9_31,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform);
float l9_42=l9_41.x;
float l9_43=l9_32;
sc_SoftwareWrapLate(l9_42,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x,l9_26,l9_43);
float l9_44=l9_41.y;
float l9_45=l9_43;
sc_SoftwareWrapLate(l9_44,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y,l9_26,l9_45);
float l9_46=l9_45;
vec3 l9_47=sc_SamplingCoordsViewToGlobal(vec2(l9_42,l9_44),additional_settings_btn_refl_texLayout,additional_settings_btn_refl_texGetStereoViewIndex());
vec4 l9_48=texture(additional_settings_btn_refl_tex,l9_47.xy,0.0);
vec4 l9_49;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_49=mix(additional_settings_btn_refl_texBorderColor,l9_48,vec4(l9_46));
}
#else
{
l9_49=l9_48;
...
#endif
vec4 l9_50=vec4(Port_Import_N062)*l9_1;
float l9_51=length((Globals.Surface_UVCoord0*Port_Input1_N009)+Port_Input2_N009);
vec4 param_10;
Node7_Gradient(l9_51,Port_Value0_N007,Port_Position1_N007,Port_Value1_N007,Port_Position2_N007,Port_Value2_N007,Port_Value3_N007,param_10,Globals);
float param_21;
Node18_Gradient(param_10.x,Port_Value0_N018,Port_Position1_N018,Port_Value1_N018,Port_Position2_N018,Port_Value2_N018,Port_Position3_N018,Port_Value3_N018,Port_Value4_N018,param_21,Globals);
vec4 l9_52=vec4(param_10.x,param_10.y,param_10.z,vec4(0.0).w);
l9_52.w=param_21;
float param_26;
Node31_Rim(Port_Normal_N031,Port_Exponent_N031,Port_Intensity_N031,param_26,Globals);
vec4 l9_53=mix(l9_52,Port_Input1_N034,vec4(param_26));
vec4 param_35;
Node14_Gradient(l9_51,Port_Value0_N014,Port_Position1_N014,Port_Value1_N014,Port_Position2_N014,Port_Value2_N014,Port_Value3_N014,param_35,Globals);
vec4 param_48;
Node21_Gradient(status,l9_52,Port_Position1_N021,l9_53,Port_Position2_N021,param_35,Port_Position3_N021,param_35,Port_Position4_N021,l9_53,l9_52,param_48,Globals);
vec4 l9_54=param_48;
vec2 l9_55=Globals.Surface_UVCoord1;
vec2 l9_56=((l9_55-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002;
vec4 l9_57;
#if (iconLayout==2)
{
bool l9_58=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_59=l9_56.x;
sc_SoftwareWrapEarly(l9_59,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_60=l9_59;
float l9_61=l9_56.y;
sc_SoftwareWrapEarly(l9_61,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_62=l9_61;
vec2 l9_63;
float l9_64;
...
{
l9_65=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_65=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_66=l9_60;
float l9_67=1.0;
sc_ClampUV(l9_66,iconUvMinMax.x,iconUvMinMax.z,l9_65,l9_67);
float l9_68=l9_66;
float l9_69=l9_67;
bool l9_70;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_70=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_70=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_71=l9_62;
float l9_72=l9_69;
sc_ClampUV(l9_71,iconUvMinMax.y,iconUvMinMax.w,l9_70,l9_72);
l9_64=l9_72;
...
#endif
vec2 l9_73=sc_TransformUV(l9_63,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_74=l9_73.x;
float l9_75=l9_64;
sc_SoftwareWrapLate(l9_74,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_58,l9_75);
float l9_76=l9_73.y;
float l9_77=l9_75;
sc_SoftwareWrapLate(l9_76,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_58,l9_77);
float l9_78=l9_77;
vec3 l9_79=sc_SamplingCoordsViewToGlobal(vec2(l9_74,l9_76),iconLayout,iconGetStereoViewIndex());
vec4 l9_80=texture(iconArrSC,l9_79,0.0);
vec4 l9_81;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_81=mix(iconBorderColor,l9_80,vec4(l9_78));
}
#else
{
l9_81=l9_80;
...
#else
{
bool l9_82=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_83=l9_56.x;
sc_SoftwareWrapEarly(l9_83,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_84=l9_83;
float l9_85=l9_56.y;
sc_SoftwareWrapEarly(l9_85,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_86=l9_85;
vec2 l9_87;
float l9_88;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_89=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
...
float l9_90=l9_84;
float l9_91=1.0;
sc_ClampUV(l9_90,iconUvMinMax.x,iconUvMinMax.z,l9_89,l9_91);
float l9_92=l9_90;
float l9_93=l9_91;
bool l9_94;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_94=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_94=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_95=l9_86;
float l9_96=l9_93;
sc_ClampUV(l9_95,iconUvMinMax.y,iconUvMinMax.w,l9_94,l9_96);
l9_88=l9_96;
...
#endif
vec2 l9_97=sc_TransformUV(l9_87,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_98=l9_97.x;
float l9_99=l9_88;
sc_SoftwareWrapLate(l9_98,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_82,l9_99);
float l9_100=l9_97.y;
float l9_101=l9_99;
sc_SoftwareWrapLate(l9_100,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_82,l9_101);
float l9_102=l9_101;
vec3 l9_103=sc_SamplingCoordsViewToGlobal(vec2(l9_98,l9_100),iconLayout,iconGetStereoViewIndex());
vec4 l9_104=texture(icon,l9_103.xy,0.0);
vec4 l9_105;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_105=mix(iconBorderColor,l9_104,vec4(l9_102));
}
#else
{
l9_105=l9_104;
...
#endif
float l9_106=radians(Port_Rotation_N000);
float l9_107=sin(l9_106);
float l9_108=cos(l9_106);
vec2 l9_109=l9_56-Port_Center_N000;
vec2 l9_110=vec2(dot(vec2(l9_108,l9_107),l9_109),dot(vec2(-l9_107,l9_108),l9_109))+Port_Center_N000;
vec4 l9_111;
#if (iconLayout==2)
{
bool l9_112=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_113=l9_110.x;
sc_SoftwareWrapEarly(l9_113,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_114=l9_113;
float l9_115=l9_110.y;
sc_SoftwareWrapEarly(l9_115,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_116=l9_115;
vec2 l9_117;
float l9_118;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_119=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_119=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_120=l9_114;
float l9_121=1.0;
sc_ClampUV(l9_120,iconUvMinMax.x,iconUvMinMax.z,l9_119,l9_121);
float l9_122=l9_120;
float l9_123=l9_121;
bool l9_124;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_124=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_124=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_125=l9_116;
float l9_126=l9_123;
sc_ClampUV(l9_125,iconUvMinMax.y,iconUvMinMax.w,l9_124,l9_126);
l9_118=l9_126;
...
#endif
vec2 l9_127=sc_TransformUV(l9_117,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_128=l9_127.x;
float l9_129=l9_118;
sc_SoftwareWrapLate(l9_128,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_112,l9_129);
float l9_130=l9_127.y;
float l9_131=l9_129;
sc_SoftwareWrapLate(l9_130,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_112,l9_131);
float l9_132=l9_131;
vec3 l9_133=sc_SamplingCoordsViewToGlobal(vec2(l9_128,l9_130),iconLayout,iconGetStereoViewIndex());
vec4 l9_134=texture(iconArrSC,l9_133,0.0);
vec4 l9_135;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_135=mix(iconBorderColor,l9_134,vec4(l9_132));
}
#else
{
l9_135=l9_134;
...
vec4 l9_158=texture(icon,l9_157.xy,0.0);
vec4 l9_159;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
...
#endif
float l9_160=clamp(status,0.0,1.0);
vec4 l9_161;
if (l9_160<Port_Position1_N136)
{
l9_161=mix(l9_57,l9_57,vec4(clamp(l9_160/Port_Position1_N136,0.0,1.0)));
}
else
{
vec4 l9_162;
if (l9_160<Port_Position2_N136)
{
l9_162=mix(l9_57,l9_57,vec4(clamp((l9_160-Port_Position1_N136)/(Port_Position2_N136-Port_Position1_N136),0.0,1.0)));
}
else
{
vec4 l9_163;
if (l9_160<Port_Position3_N136)
{
l9_163=mix(l9_57,l9_111,vec4(clamp((l9_160-Port_Position2_N136)/(Port_Position3_N136-Port_Position2_N136),0.0,1.0)));
}
else
{
vec4 l9_164;
if (l9_160<Port_Position4_N136)
{
l9_164=mix(l9_111,l9_111,vec4(clamp((l9_160-Port_Position3_N136)/(Port_Position4_N136-Port_Position3_N136),0.0,1.0)));
}
else
{
l9_164=mix(l9_111,l9_111,vec4(clamp((l9_160-Port_Position4_N136)/(1.0-Port_Position4_N136),0.0,1.0)));
}
l9_163=l9_164;
}
l9_162=l9_163;
...
Value1=mix(l9_50+l9_54,l9_161,vec4(l9_161.w));
Result=Value1;
}
else
{
vec3 param_51;
Node70_Normalize(mat3(Globals.VertexTangent_WorldSpace,Globals.VertexBinormal_WorldSpace,Globals.VertexNormal_WorldSpace)*Port_Import_N068,param_51,Globals);
vec3 l9_165=((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(param_51,0.0)).xyz*vec3(Port_Input1_N073))+vec3(Port_Input2_N073);
vec4 l9_166;
#if (additional_settings_btn_refl_texLayout==2)
{
bool l9_167=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0));
float l9_168=l9_165.x;
sc_SoftwareWrapEarly(l9_168,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x);
float l9_169=l9_168;
float l9_170=l9_165.y;
sc_SoftwareWrapEarly(l9_170,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y);
float l9_171=l9_170;
vec2 l9_172;
float l9_173;
#if (SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)
...
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_174=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x==3;
}
#else
{
l9_174=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_175=l9_169;
float l9_176=1.0;
sc_ClampUV(l9_175,additional_settings_btn_refl_texUvMinMax.x,additional_settings_btn_refl_texUvMinMax.z,l9_174,l9_176);
float l9_177=l9_175;
float l9_178=l9_176;
bool l9_179;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_179=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y==3;
}
#else
{
l9_179=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_180=l9_171;
float l9_181=l9_178;
sc_ClampUV(l9_180,additional_settings_btn_refl_texUvMinMax.y,additional_settings_btn_refl_texUvMinMax.w,l9_179,l9_181);
l9_173=l9_181;
...
#endif
vec2 l9_182=sc_TransformUV(l9_172,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform);
float l9_183=l9_182.x;
float l9_184=l9_173;
sc_SoftwareWrapLate(l9_183,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x,l9_167,l9_184);
float l9_185=l9_182.y;
float l9_186=l9_184;
sc_SoftwareWrapLate(l9_185,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y,l9_167,l9_186);
float l9_187=l9_186;
vec3 l9_188=sc_SamplingCoordsViewToGlobal(vec2(l9_183,l9_185),additional_settings_btn_refl_texLayout,additional_settings_btn_refl_texGetStereoViewIndex());
vec4 l9_189=texture(additional_settings_btn_refl_texArrSC,l9_188,0.0);
vec4 l9_190;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_190=mix(additional_settings_btn_refl_texBorderColor,l9_189,vec4(l9_187));
}
#else
{
l9_190=l9_189;
...
#else
{
bool l9_191=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0));
float l9_192=l9_165.x;
sc_SoftwareWrapEarly(l9_192,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x);
float l9_193=l9_192;
float l9_194=l9_165.y;
sc_SoftwareWrapEarly(l9_194,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y);
float l9_195=l9_194;
vec2 l9_196;
float l9_197;
#if (SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)
...
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_198=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x==3;
}
#else
{
l9_198=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_199=l9_193;
float l9_200=1.0;
sc_ClampUV(l9_199,additional_settings_btn_refl_texUvMinMax.x,additional_settings_btn_refl_texUvMinMax.z,l9_198,l9_200);
float l9_201=l9_199;
float l9_202=l9_200;
bool l9_203;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_203=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y==3;
}
#else
{
l9_203=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_204=l9_195;
float l9_205=l9_202;
sc_ClampUV(l9_204,additional_settings_btn_refl_texUvMinMax.y,additional_settings_btn_refl_texUvMinMax.w,l9_203,l9_205);
l9_197=l9_205;
...
#endif
vec2 l9_206=sc_TransformUV(l9_196,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform);
float l9_207=l9_206.x;
float l9_208=l9_197;
sc_SoftwareWrapLate(l9_207,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x,l9_191,l9_208);
float l9_209=l9_206.y;
float l9_210=l9_208;
sc_SoftwareWrapLate(l9_209,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y,l9_191,l9_210);
float l9_211=l9_210;
vec3 l9_212=sc_SamplingCoordsViewToGlobal(vec2(l9_207,l9_209),additional_settings_btn_refl_texLayout,additional_settings_btn_refl_texGetStereoViewIndex());
vec4 l9_213=texture(additional_settings_btn_refl_tex,l9_212.xy,0.0);
vec4 l9_214;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_214=mix(additional_settings_btn_refl_texBorderColor,l9_213,vec4(l9_211));
}
#else
{
l9_214=l9_213;
...
#endif
float l9_215=length((Globals.Surface_UVCoord0*Port_Input1_N009)+Port_Input2_N009);
vec4 param_60;
Node7_Gradient(l9_215,Port_Value0_N007,Port_Position1_N007,Port_Value1_N007,Port_Position2_N007,Port_Value2_N007,Port_Value3_N007,param_60,Globals);
float param_71;
Node18_Gradient(param_60.x,Port_Value0_N018,Port_Position1_N018,Port_Value1_N018,Port_Position2_N018,Port_Value2_N018,Port_Position3_N018,Port_Value3_N018,Port_Value4_N018,param_71,Globals);
vec4 l9_216=vec4(param_60.x,param_60.y,param_60.z,vec4(0.0).w);
l9_216.w=param_71;
float param_76;
Node31_Rim(Port_Normal_N031,Port_Exponent_N031,Port_Intensity_N031,param_76,Globals);
vec4 l9_217=mix(l9_216,Port_Input1_N034,vec4(param_76));
vec4 param_85;
Node14_Gradient(l9_215,Port_Value0_N014,Port_Position1_N014,Port_Value1_N014,Port_Position2_N014,Port_Value2_N014,Port_Value3_N014,param_85,Globals);
vec4 param_98;
Node21_Gradient(status,l9_216,Port_Position1_N021,l9_217,Port_Position2_N021,param_85,Port_Position3_N021,param_85,Port_Position4_N021,l9_217,l9_216,param_98,Globals);
Default=(vec4(Port_Import_N062)*l9_166)+param_98;
Result=Default;
}
}
...
l9_7=l9_12;
l9_6=l9_13;
l9_5=cross(l9_13,l9_12)*varTangent.w;
l9_4=varTex01.xy;
...
vec4 param_4;
Node16_If_else(0.0,vec4(0.0),vec4(0.0),param_4,ssGlobals(sc_Time.x,sc_Time.y,0.0,l9_7,l9_6,l9_5,l9_4,l9_3,l9_2,l9_1));
vec4 l9_14=param_4;
vec4 l9_15=(l9_14+baseColor)/(vec4(Port_Input1_N005)+vec4(1.234e-06));
float l9_16=l9_15.w;
...
#endif
sc_writeFragData0(max(l9_17,vec4(0.0)));
return;
}
vec4 l9_19;
...
{
l9_22=clamp(dot(l9_15.xyz,vec3(l9_16)),0.0,1.0);
}
#else
{
float l9_23;
...
{
l9_24=(1.0-dot(l9_15.xyz,vec3(0.33333001)))*l9_16;
}
#else
{
float l9_25;
...
{
l9_25=(1.0-clamp(dot(l9_15.xyz,vec3(1.0)),0.0,1.0))*l9_16;
}
#else
{
float l9_26;
...
#if (sc_BlendMode_Add)
{
l9_27=clamp(dot(l9_15.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_28;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_28=clamp(dot(l9_15.xyz,vec3(1.0)),0.0,1.0)*l9_16;
}
#else
{
float l9_29;
...
{
l9_29=dot(l9_15.xyz,vec3(0.33333001))*l9_16;
}
#else
{
float l9_30;
#if (sc_BlendMode_Min)
{
l9_30=1.0-clamp(dot(l9_15.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_31;
#if (sc_BlendMode_Max)
{
l9_31=clamp(dot(l9_15.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_31=1.0;
...
#endif
l9_19=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_15.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_20);
}
#else
{
vec4 l9_32;
...
{
l9_36=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_35,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_36=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_35,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_34=l9_36;
}
#endif
vec3 l9_37=mix(l9_34.xyz,definedBlend(l9_34.xyz,l9_15.xyz).xyz,vec3(l9_16));
...
#if (sc_Voxelization)
{
l9_39=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_40;
#if (sc_OutputBounds)
{
float l9_41=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_40=vec4(l9_41,1.0-l9_41,1.0,1.0);
}
#else
{
vec4 l9_42;
...
vec4 l9_47=sc_OutputMotionVectorIfNeeded(max(l9_45,vec4(0.0)));
