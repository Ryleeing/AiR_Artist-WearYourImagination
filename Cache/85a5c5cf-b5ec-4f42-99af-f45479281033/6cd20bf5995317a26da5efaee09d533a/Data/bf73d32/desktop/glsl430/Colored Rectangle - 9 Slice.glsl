...
{
l9_71=clamp(dot(l9_64.xyz,vec3(l9_65)),0.0,1.0);
}
#else
{
float l9_72;
...
{
l9_73=(1.0-dot(l9_64.xyz,vec3(0.33333001)))*l9_65;
}
#else
{
float l9_74;
...
{
l9_74=(1.0-clamp(dot(l9_64.xyz,vec3(1.0)),0.0,1.0))*l9_65;
}
#else
{
float l9_75;
...
{
l9_75=clamp(dot(l9_64.xyz,vec3(1.0)),0.0,1.0)*l9_65;
}
#else
{
float l9_76;
#if (sc_BlendMode_Add)
{
l9_76=clamp(dot(l9_64.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_77;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_77=clamp(dot(l9_64.xyz,vec3(1.0)),0.0,1.0)*l9_65;
}
#else
{
float l9_78;
...
{
l9_78=dot(l9_64.xyz,vec3(0.33333001))*l9_65;
}
#else
{
float l9_79;
#if (sc_BlendMode_Min)
{
l9_79=1.0-clamp(dot(l9_64.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_80;
#if (sc_BlendMode_Max)
{
l9_80=clamp(dot(l9_64.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_80=1.0;
...
#endif
l9_68=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_64.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_69);
}
#else
{
vec4 l9_81;
...
#endif
vec3 l9_86=mix(l9_83.xyz,definedBlend(l9_83.xyz,l9_64.xyz).xyz,vec3(l9_65));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_91=vec4(mix(vec3(1.0),l9_64.xyz,vec3(l9_65)),l9_65);
}
#else
{
vec4 l9_92;
...
#endif
l9_92=vec4(l9_64.xyz*l9_93,l9_93);
}
#else
{
l9_92=l9_64;
