...
//sampler sampler Tweak_N2SmpSC 0:21
...
//texture texture2D Tweak_N2 0:3:0:21
...
//texture texture2DArray Tweak_N2ArrSC 0:32:0:21
...
//spec_const int Tweak_N2Layout 80 0
...
uniform bool AnimationSwitch;
uniform float WaveSpeed;
uniform float switchSize;
uniform vec4 whiteColor;
uniform float Thickness;
uniform float InnerCircleMask;
uniform vec2 Port_Center_N030;
uniform vec2 Port_Scale_N030;
uniform vec2 Port_Center_N133;
uniform vec2 Port_Scale_N133;
uniform vec2 Port_Center_N137;
uniform vec2 Port_Scale_N137;
uniform bool showMask;
uniform float Port_Value0_N001;
uniform float Port_Default_N001;
uniform float Port_Input1_N112;
uniform float Port_Input1_N177;
uniform float Port_RangeMinA_N176;
uniform float Port_RangeMaxA_N176;
uniform float Port_RangeMaxB_N176;
uniform float Port_RangeMinB_N176;
uniform float Port_RangeMinA_N173;
uniform float Port_RangeMaxA_N173;
uniform float Port_RangeMaxB_N173;
uniform float Port_RangeMinB_N173;
...
uniform float Port_RangeMinA_N157;
uniform float Port_RangeMaxA_N157;
uniform float Port_RangeMinB_N157;
uniform float Port_RangeMinA_N159;
uniform float Port_RangeMaxA_N159;
uniform float Port_RangeMaxB_N159;
uniform float Port_RangeMinB_N159;
uniform vec2 Port_Input1_N034;
uniform float Port_Input1_N166;
uniform float Port_Input2_N166;
...
uniform float Port_Value_N115;
uniform vec2 Port_Input1_N031;
uniform float Port_Rotation_N083;
uniform vec2 Port_Center_N083;
uniform vec2 Port_Import_N142;
uniform float Port_Import_N141;
uniform vec2 Port_Import_N139;
uniform vec2 Port_Default_N136;
uniform float Port_Value_N055;
uniform vec2 Port_Input2_N018;
uniform float Port_Value_N113;
uniform vec2 Port_Center_N063;
uniform vec2 Port_Scale_N063;
uniform float Port_Rotation_N025;
uniform vec2 Port_Center_N025;
uniform mat3 Tweak_N2Transform;
uniform vec4 Tweak_N2UvMinMax;
uniform vec4 Tweak_N2BorderColor;
uniform float Port_RangeMinA_N059;
uniform float Port_RangeMaxA_N059;
uniform float Port_RangeMaxB_N059;
uniform float Port_RangeMinB_N059;
...
uniform float Port_Input2_N102;
...
uniform float Port_Input0_N127;
uniform float Port_Input2_N006;
uniform float Port_RangeMinA_N148;
uniform float Port_RangeMaxA_N148;
uniform float Port_RangeMaxB_N148;
uniform float Port_RangeMinB_N148;
uniform float Port_Input0_N103;
uniform float Port_RangeMinA_N105;
uniform float Port_RangeMaxA_N105;
uniform float Port_RangeMaxB_N105;
uniform float Port_RangeMinB_N105;
uniform float Port_Input1_N027;
uniform float Port_Input2_N027;
uniform float Port_Value0_N100;
uniform float Port_Default_N100;
uniform int PreviewEnabled;
...
uniform sampler2DArray Tweak_N2ArrSC;
...
void Node1_Switch(float Switch,float Value0,float Value1,float Default,out float Result,ssGlobals Globals)
{
Switch=float(AnimationSwitch);
Switch=floor(Switch);
if (Switch==0.0)
{
Result=Value0;
...
if (Switch==1.0)
{
Value1=Globals.gTimeElapsed*WaveSpeed;
Result=Value1;
}
else
{
...
float param_5;
Node1_Switch(0.0,Port_Value0_N001,0.0,Port_Default_N001,param_5,l9_3);
float l9_4=param_5;
float l9_5=mod(l9_4,Port_Input1_N112);
float l9_6;
if (l9_5<=0.0)
{
l9_6=0.0;
...
{
l9_6=pow(l9_5,Port_Input1_N177);
}
float l9_7=(((switchSize-Port_RangeMinA_N176)/((Port_RangeMaxA_N176-Port_RangeMinA_N176)+1e-06))*(Port_RangeMaxB_N176-Port_RangeMinB_N176))+Port_RangeMinB_N176;
float l9_8=l9_6-Port_RangeMinA_N155;
float l9_9=(Port_RangeMaxA_N155-Port_RangeMinA_N155)+1e-06;
float l9_10=((((switchSize-Port_RangeMinA_N173)/((Port_RangeMaxA_N173-Port_RangeMinA_N173)+1e-06))*(Port_RangeMaxB_N173-Port_RangeMinB_N173))+Port_RangeMinB_N173)-l9_7;
float l9_11=((l9_8/l9_9)*l9_10)+l9_7;
float l9_12=l9_6-Port_RangeMinA_N157;
float l9_13=(Port_RangeMaxA_N157-Port_RangeMinA_N157)+1e-06;
float l9_14=((((switchSize-Port_RangeMinA_N174)/((Port_RangeMaxA_N174-Port_RangeMinA_N174)+1e-06))*(Port_RangeMaxB_N174-Port_RangeMinB_N174))+Port_RangeMinB_N174)-Port_RangeMinB_N157;
float l9_15=l9_11+(((l9_12/l9_13)*l9_14)+Port_RangeMinB_N157);
float l9_16=l9_6-Port_RangeMinA_N159;
float l9_17=(Port_RangeMaxA_N159-Port_RangeMinA_N159)+1e-06;
float l9_18=Port_RangeMaxB_N159-Port_RangeMinB_N159;
float l9_19=((l9_16/l9_17)*l9_18)+Port_RangeMinB_N159;
float l9_20=distance(l9_1,Port_Input1_N034);
float l9_21=Port_Input1_N166+0.001;
float l9_22=Port_Input2_N166+0.001;
float l9_23=smoothstep(Port_Input0_N167,Port_Input1_N167,l9_6);
float l9_24=(Port_Value_N117+0.001)-0.001;
float l9_25=l9_24+((((Thickness-Port_RangeMinA_N022)/((Port_RangeMaxA_N022-Port_RangeMinA_N022)+1e-06))*(Port_RangeMaxB_N022-Port_RangeMinB_N022))+Port_RangeMinB_N022);
float l9_26=(Port_Value_N115+0.001)-0.001;
float l9_27=distance(l9_1,Port_Input1_N031);
float l9_28=smoothstep(l9_25,l9_25+l9_26,l9_27)-smoothstep(l9_24,l9_24+l9_26,l9_27);
float l9_29=radians(Port_Rotation_N083);
float l9_30=sin(l9_29);
float l9_31=cos(l9_29);
vec2 l9_32=l9_1-Port_Center_N083;
float l9_33=radians(Port_Import_N141);
float l9_34=sin(l9_33);
float l9_35=cos(l9_33);
vec2 l9_36=(vec2(dot(vec2(l9_31,l9_30),l9_32),dot(vec2(-l9_30,l9_31),l9_32))+Port_Center_N083)-Port_Import_N139;
vec2 l9_37=((vec2(dot(vec2(l9_35,l9_34),l9_36),dot(vec2(-l9_34,l9_35),l9_36))*(Port_Import_N142*2.0))+Port_Import_N139)-Port_Import_N139;
float l9_38=l9_37.y;
float l9_39;
if (l9_38==0.0)
{
...
{
l9_39=atan(l9_38,l9_37.x);
}
float l9_40=l9_39-(-3.1415927);
vec4 l9_41=mix(mix(dotsColor,circleColor,vec4((clamp((smoothstep(l9_15,l9_19+l9_15,l9_20)-smoothstep(l9_11,l9_19+l9_11,l9_20))+0.001,l9_21,l9_22)-0.001)*l9_23)),mix(whiteColor,dotsColor,vec4(l9_28*(1.0-smoothstep(InnerCircleMask,InnerCircleMask,1.0-(0.0+((l9_40*1.0)/((3.1415927-(-3.1415927))+1e-06))))))),vec4(l9_28));
float l9_42=floor(switchSize);
vec2 l9_43;
if (l9_42==0.0)
{
l9_43=((l9_1-Port_Center_N030)*Port_Scale_N030)+Port_Center_N030;
}
else
{
vec2 l9_44;
if (l9_42==1.0)
{
l9_44=((l9_1-Port_Center_N133)*Port_Scale_N133)+Port_Center_N133;
}
else
{
vec2 l9_45;
if (l9_42==2.0)
{
l9_45=((l9_1-Port_Center_N137)*Port_Scale_N137)+Port_Center_N137;
}
else
{
l9_45=Port_Default_N136;
}
l9_44=l9_45;
}
l9_43=l9_44;
}
vec2 l9_46=l9_43*vec2((Port_Value_N055+0.001)-0.001);
float l9_47=radians(Port_Rotation_N025);
float l9_48=sin(l9_47);
float l9_49=cos(l9_47);
vec2 l9_50=(((((l9_46+Port_Input2_N018)+vec2((Port_Value_N113+0.001)-0.001))-Port_Center_N063)*Port_Scale_N063)+Port_Center_N063)-Port_Center_N025;
vec2 l9_51=vec2(dot(vec2(l9_49,l9_48),l9_50),dot(vec2(-l9_48,l9_49),l9_50))+Port_Center_N025;
vec4 l9_52;
#if (Tweak_N2Layout==2)
{
bool l9_53=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N2)!=0));
float l9_54=l9_51.x;
sc_SoftwareWrapEarly(l9_54,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).x);
float l9_55=l9_54;
float l9_56=l9_51.y;
sc_SoftwareWrapEarly(l9_56,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).y);
float l9_57=l9_56;
vec2 l9_58;
float l9_59;
...
{
l9_60=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).x==3;
}
#else
{
l9_60=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2)!=0);
}
#endif
float l9_61=l9_55;
float l9_62=1.0;
sc_ClampUV(l9_61,Tweak_N2UvMinMax.x,Tweak_N2UvMinMax.z,l9_60,l9_62);
float l9_63=l9_61;
float l9_64=l9_62;
bool l9_65;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N2)
{
l9_65=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).y==3;
}
#else
{
l9_65=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2)!=0);
}
#endif
float l9_66=l9_57;
float l9_67=l9_64;
sc_ClampUV(l9_66,Tweak_N2UvMinMax.y,Tweak_N2UvMinMax.w,l9_65,l9_67);
l9_59=l9_67;
...
#endif
vec2 l9_68=sc_TransformUV(l9_58,(int(SC_USE_UV_TRANSFORM_Tweak_N2)!=0),Tweak_N2Transform);
float l9_69=l9_68.x;
float l9_70=l9_59;
sc_SoftwareWrapLate(l9_69,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).x,l9_53,l9_70);
float l9_71=l9_68.y;
float l9_72=l9_70;
sc_SoftwareWrapLate(l9_71,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).y,l9_53,l9_72);
float l9_73=l9_72;
vec3 l9_74=sc_SamplingCoordsViewToGlobal(vec2(l9_69,l9_71),Tweak_N2Layout,Tweak_N2GetStereoViewIndex());
vec4 l9_75=texture(Tweak_N2ArrSC,l9_74,0.0);
vec4 l9_76;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N2)
{
l9_76=mix(Tweak_N2BorderColor,l9_75,vec4(l9_73));
}
#else
{
l9_76=l9_75;
...
#else
{
bool l9_77=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N2)!=0));
float l9_78=l9_51.x;
sc_SoftwareWrapEarly(l9_78,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).x);
float l9_79=l9_78;
float l9_80=l9_51.y;
sc_SoftwareWrapEarly(l9_80,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).y);
float l9_81=l9_80;
vec2 l9_82;
float l9_83;
#if (SC_USE_UV_MIN_MAX_Tweak_N2)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N2)
{
l9_84=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).x==3;
}
#else
{
l9_84=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2)!=0);
}
#endif
float l9_85=l9_79;
float l9_86=1.0;
sc_ClampUV(l9_85,Tweak_N2UvMinMax.x,Tweak_N2UvMinMax.z,l9_84,l9_86);
float l9_87=l9_85;
float l9_88=l9_86;
bool l9_89;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N2)
{
l9_89=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).y==3;
}
#else
{
l9_89=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2)!=0);
}
#endif
float l9_90=l9_81;
float l9_91=l9_88;
sc_ClampUV(l9_90,Tweak_N2UvMinMax.y,Tweak_N2UvMinMax.w,l9_89,l9_91);
l9_83=l9_91;
...
#endif
vec2 l9_92=sc_TransformUV(l9_82,(int(SC_USE_UV_TRANSFORM_Tweak_N2)!=0),Tweak_N2Transform);
float l9_93=l9_92.x;
float l9_94=l9_83;
sc_SoftwareWrapLate(l9_93,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).x,l9_77,l9_94);
float l9_95=l9_92.y;
float l9_96=l9_94;
sc_SoftwareWrapLate(l9_95,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).y,l9_77,l9_96);
float l9_97=l9_96;
vec3 l9_98=sc_SamplingCoordsViewToGlobal(vec2(l9_93,l9_95),Tweak_N2Layout,Tweak_N2GetStereoViewIndex());
vec4 l9_99=texture(Tweak_N2,l9_98.xy,0.0);
vec4 l9_100;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N2)
{
l9_100=mix(Tweak_N2BorderColor,l9_99,vec4(l9_97));
}
#else
{
l9_100=l9_99;
...
#if (Tweak_N2Layout==2)
{
bool l9_102=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N2)!=0));
float l9_103=l9_51.x;
sc_SoftwareWrapEarly(l9_103,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).x);
float l9_104=l9_103;
float l9_105=l9_51.y;
sc_SoftwareWrapEarly(l9_105,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).y);
float l9_106=l9_105;
vec2 l9_107;
float l9_108;
#if (SC_USE_UV_MIN_MAX_Tweak_N2)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N2)
{
l9_109=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).x==3;
}
#else
{
l9_109=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2)!=0);
}
#endif
float l9_110=l9_104;
float l9_111=1.0;
sc_ClampUV(l9_110,Tweak_N2UvMinMax.x,Tweak_N2UvMinMax.z,l9_109,l9_111);
float l9_112=l9_110;
float l9_113=l9_111;
bool l9_114;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N2)
{
l9_114=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).y==3;
}
#else
{
l9_114=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2)!=0);
}
#endif
float l9_115=l9_106;
float l9_116=l9_113;
sc_ClampUV(l9_115,Tweak_N2UvMinMax.y,Tweak_N2UvMinMax.w,l9_114,l9_116);
l9_108=l9_116;
...
#endif
vec2 l9_117=sc_TransformUV(l9_107,(int(SC_USE_UV_TRANSFORM_Tweak_N2)!=0),Tweak_N2Transform);
float l9_118=l9_117.x;
float l9_119=l9_108;
sc_SoftwareWrapLate(l9_118,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).x,l9_102,l9_119);
float l9_120=l9_117.y;
float l9_121=l9_119;
sc_SoftwareWrapLate(l9_120,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).y,l9_102,l9_121);
float l9_122=l9_121;
vec3 l9_123=sc_SamplingCoordsViewToGlobal(vec2(l9_118,l9_120),Tweak_N2Layout,Tweak_N2GetStereoViewIndex());
vec4 l9_124=texture(Tweak_N2ArrSC,l9_123,0.0);
vec4 l9_125;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N2)
{
l9_125=mix(Tweak_N2BorderColor,l9_124,vec4(l9_122));
}
#else
{
l9_125=l9_124;
...
#else
{
bool l9_126=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N2)!=0));
float l9_127=l9_51.x;
sc_SoftwareWrapEarly(l9_127,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).x);
float l9_128=l9_127;
float l9_129=l9_51.y;
sc_SoftwareWrapEarly(l9_129,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).y);
float l9_130=l9_129;
vec2 l9_131;
float l9_132;
#if (SC_USE_UV_MIN_MAX_Tweak_N2)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N2)
{
l9_133=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).x==3;
}
#else
{
l9_133=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2)!=0);
}
#endif
float l9_134=l9_128;
float l9_135=1.0;
sc_ClampUV(l9_134,Tweak_N2UvMinMax.x,Tweak_N2UvMinMax.z,l9_133,l9_135);
float l9_136=l9_134;
float l9_137=l9_135;
bool l9_138;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N2)
{
l9_138=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).y==3;
}
#else
{
l9_138=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2)!=0);
}
#endif
float l9_139=l9_130;
float l9_140=l9_137;
sc_ClampUV(l9_139,Tweak_N2UvMinMax.y,Tweak_N2UvMinMax.w,l9_138,l9_140);
l9_132=l9_140;
...
#endif
vec2 l9_141=sc_TransformUV(l9_131,(int(SC_USE_UV_TRANSFORM_Tweak_N2)!=0),Tweak_N2Transform);
float l9_142=l9_141.x;
float l9_143=l9_132;
sc_SoftwareWrapLate(l9_142,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).x,l9_126,l9_143);
float l9_144=l9_141.y;
float l9_145=l9_143;
sc_SoftwareWrapLate(l9_144,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).y,l9_126,l9_145);
float l9_146=l9_145;
vec3 l9_147=sc_SamplingCoordsViewToGlobal(vec2(l9_142,l9_144),Tweak_N2Layout,Tweak_N2GetStereoViewIndex());
vec4 l9_148=texture(Tweak_N2,l9_147.xy,0.0);
vec4 l9_149;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N2)
{
l9_149=mix(Tweak_N2BorderColor,l9_148,vec4(l9_146));
}
#else
{
l9_149=l9_148;
...
#endif
float l9_150=l9_6-Port_RangeMinA_N036;
float l9_151=((l9_150/((Port_RangeMaxA_N036-Port_RangeMinA_N036)+1e-06))*(((((switchSize-Port_RangeMinA_N059)/((Port_RangeMaxA_N059-Port_RangeMinA_N059)+1e-06))*(Port_RangeMaxB_N059-Port_RangeMinB_N059))+Port_RangeMinB_N059)-Port_RangeMinB_N036))+Port_RangeMinB_N036;
float l9_152=l9_6-Port_RangeMinA_N043;
float l9_153=l9_151+(((l9_152/((Port_RangeMaxA_N043-Port_RangeMinA_N043)+1e-06))*(Port_RangeMaxB_N043-Port_RangeMinB_N043))+Port_RangeMinB_N043);
float l9_154=l9_6-Port_RangeMinA_N046;
float l9_155=((l9_154/((Port_RangeMaxA_N046-Port_RangeMinA_N046)+1e-06))*(Port_RangeMaxB_N046-Port_RangeMinB_N046))+Port_RangeMinB_N046;
float l9_156=smoothstep(Port_Input0_N088,Port_Input1_N088,l9_6);
float l9_157=(((switchSize-Port_RangeMinA_N017)/((Port_RangeMaxA_N017-Port_RangeMinA_N017)+1e-06))*(Port_RangeMaxB_N017-Port_RangeMinB_N017))+Port_RangeMinB_N017;
float l9_158=distance(l9_1,Port_Input1_N014);
float l9_159=floor(float(showMask));
float l9_160;
if (l9_159==0.0)
{
l9_160=Port_Value0_N100;
}
else
{
float l9_161;
...
{
float l9_162;
Node1_Switch(0.0,Port_Value0_N001,0.0,Port_Default_N001,l9_162,l9_3);
float l9_163=l9_162;
float l9_164=mod(l9_163,Port_Input1_N112);
float l9_165;
if (l9_164<=0.0)
{
l9_165=0.0;
...
{
l9_165=pow(l9_164,Port_Input1_N177);
}
float l9_166=(((l9_165-Port_RangeMinA_N155)/l9_9)*l9_10)+l9_7;
float l9_167=l9_166+((((l9_165-Port_RangeMinA_N157)/l9_13)*l9_14)+Port_RangeMinB_N157);
float l9_168=(((l9_165-Port_RangeMinA_N159)/l9_17)*l9_18)+Port_RangeMinB_N159;
l9_161=(((((clamp((smoothstep(l9_167,l9_168+l9_167,l9_20)-smoothstep(l9_166,l9_168+l9_166,l9_20))+0.001,l9_21,l9_22)-0.001)*smoothstep(Port_Input0_N167,Port_Input1_N167,l9_165))*((((l9_165-Port_RangeMinA_N049)/((Port_RangeMaxA_N049-Port_RangeMinA_N049)+1e-06))*(Port_RangeMaxB_N049-Port_RangeMinB_N049))+Port_RangeMinB_N049))*Port_Input2_N050)+Port_Input1_N048)*Port_Input1_N054;
}
else
{
l9_161=Port_Default_N100;
}
l9_160=l9_161;
}
float l9_169=max((((((mix(l9_52.x,l9_101.y,clamp((((clamp((smoothstep(l9_153,l9_155+l9_153,l9_27)-smoothstep(l9_151,l9_155+l9_151,l9_27))+0.001,Port_Input1_N051+0.001,Port_Input2_N051+0.001)-0.001)*l9_156)*Port_Input1_N101)+0.001,Port_Input1_N102+0.001,Port_Input2_N102+0.001)-0.001)+Port_Input1_N069)*(Port_Input0_N127*(1.0-smoothstep(l9_157,l9_157+Port_Input1_N020,l9_158))))*Port_Input2_N006)*((((smoothstep(Port_Input0_N103,(((switchSize-Port_RangeMinA_N148)/((Port_RangeMaxA_N148-Port_RangeMinA_N148)+1e-06))*(Port_RangeMaxB_N148-Port_RangeMinB_N148))+Port_RangeMinB_N148,l9_27)-Port_RangeMinA_N105)/((Port_RangeMaxA_N105-Port_RangeMinA_N105)+1e-06))*(Port_RangeMaxB_N105-Port_RangeMinB_N105))+Port_RangeMinB_N105))+Port_Input1_N027)+Port_Input2_N027,l9_160);
float l9_170=l9_169*Alpha;
vec4 l9_171=vec4(l9_41.x,l9_41.y,l9_41.z,vec4(0.0).w);
l9_171.w=l9_170;
#if (sc_BlendMode_AlphaTest)
{
if (l9_170<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_170<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0(max(l9_172,vec4(0.0)));
return;
}
vec4 l9_174;
...
{
l9_176=clamp(l9_170*2.0,0.0,1.0);
}
#else
{
float l9_177;
...
{
l9_177=clamp(dot(l9_171.xyz,vec3(l9_170)),0.0,1.0);
}
#else
{
float l9_178;
...
{
l9_179=(1.0-dot(l9_171.xyz,vec3(0.33333001)))*l9_170;
}
#else
{
float l9_180;
...
{
l9_180=(1.0-clamp(dot(l9_171.xyz,vec3(1.0)),0.0,1.0))*l9_170;
}
#else
{
float l9_181;
...
{
l9_181=clamp(dot(l9_171.xyz,vec3(1.0)),0.0,1.0)*l9_170;
}
#else
{
float l9_182;
#if (sc_BlendMode_Add)
{
l9_182=clamp(dot(l9_171.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_183;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_183=clamp(dot(l9_171.xyz,vec3(1.0)),0.0,1.0)*l9_170;
}
#else
{
float l9_184;
...
{
l9_184=dot(l9_171.xyz,vec3(0.33333001))*l9_170;
}
#else
{
float l9_185;
#if (sc_BlendMode_Min)
{
l9_185=1.0-clamp(dot(l9_171.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_186;
#if (sc_BlendMode_Max)
{
l9_186=clamp(dot(l9_171.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_186=1.0;
...
#endif
l9_174=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_171.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_175);
}
#else
{
vec4 l9_187;
...
{
l9_191=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_190,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_191=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_190,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_189=l9_191;
}
#endif
vec3 l9_192=mix(l9_189.xyz,definedBlend(l9_189.xyz,l9_171.xyz).xyz,vec3(l9_170));
...
#if (sc_Voxelization)
{
l9_194=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_195;
#if (sc_OutputBounds)
{
float l9_196=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_195=vec4(l9_196,1.0-l9_196,1.0,1.0);
}
#else
{
vec4 l9_197;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_197=vec4(mix(vec3(1.0),l9_171.xyz,vec3(l9_170)),l9_170);
}
#else
{
vec4 l9_198;
...
#endif
l9_198=vec4(l9_171.xyz*l9_199,l9_199);
}
#else
{
l9_198=l9_171;
...
vec4 l9_202=sc_OutputMotionVectorIfNeeded(max(l9_200,vec4(0.0)));
vec4 l9_203=clamp(l9_202,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_204=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_204-0.0039215689)),min(1.0,l9_204+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#endif
int l9_206=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_205).xy);
float l9_207=packValue(l9_206);
int l9_214=int(l9_203.w*255.0);
float l9_215=packValue(l9_214);
sc_writeFragData0(vec4(packValue(l9_206),packValue(l9_206),packValue(l9_206),packValue(l9_206)));
}
#endif
}
#else
...
if (l9_223==0)
{
l9_226=texture(sc_OITAlpha0,l9_218);
l9_225=texture(sc_OITDepthLow0,l9_218);
l9_224=texture(sc_OITDepthHigh0,l9_218);
}
else
{
l9_226=vec4(0.0);
...
if (l9_223==1)
{
l9_229=texture(sc_OITAlpha1,l9_218);
l9_228=texture(sc_OITDepthLow1,l9_218);
l9_227=texture(sc_OITDepthHigh1,l9_218);
}
else
{
l9_229=l9_226;
...
if (any(notEqual(l9_227,vec4(0.0)))||any(notEqual(l9_228,vec4(0.0))))
{
int l9_230[8]=l9_219;
unpackValues(l9_227.w,l9_223,l9_230);
unpackValues(l9_227.z,l9_223,l9_230);
unpackValues(l9_227.y,l9_223,l9_230);
unpackValues(l9_227.x,l9_223,l9_230);
unpackValues(l9_228.w,l9_223,l9_230);
unpackValues(l9_228.z,l9_223,l9_230);
unpackValues(l9_228.y,l9_223,l9_230);
unpackValues(l9_228.x,l9_223,l9_230);
int l9_239[8]=l9_220;
unpackValues(l9_229.w,l9_223,l9_239);
unpackValues(l9_229.z,l9_223,l9_239);
unpackValues(l9_229.y,l9_223,l9_239);
unpackValues(l9_229.x,l9_223,l9_239);
}
l9_223++;
continue;
}
...
vec4 l9_244=texture(sc_OITFilteredDepthBoundsTexture,l9_218);
vec2 l9_245=l9_244.xy;
int l9_246;
#if (sc_SkinBonesCount>0)
{
l9_246=encodeDepth(((1.0-l9_244.x)*1000.0)+getDepthOrderingEpsilon(),l9_245);
}
#else
{
l9_246=0;
...
#endif
int l9_247=encodeDepth(viewSpaceDepth(),l9_245);
vec4 l9_248;
l9_248=l9_203*l9_203.w;
vec4 l9_249;
int l9_250=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_250<8)
{
int l9_251=l9_219[l9_250];
int l9_252=l9_247-l9_246;
bool l9_253=l9_251<l9_252;
bool l9_254;
if (l9_253)
{
l9_254=l9_219[l9_250]>0;
}
else
{
l9_254=l9_253;
...
if (l9_254)
{
vec3 l9_255=l9_248.xyz*(1.0-(float(l9_220[l9_250])/255.0));
l9_249=vec4(l9_255.x,l9_255.y,l9_255.z,l9_248.w);
}
else
{
l9_249=l9_248;
