...
//spec_const bool Tweak_N71 39 0
...
//spec_const int baseTexLayout 82 0
...
l9_9=varTangent.xyz;
l9_8=varNormalAndMotion.xyz;
l9_7=(sc_ModelMatrix*vec4(((sc_ModelMatrixInverse*vec4(varPosAndMotion.xyz,1.0)).xyz*vec3(((Port_Value_N057+0.001)-0.001)+1.0))+Port_Input2_N052,1.0)).xyz;
}
...
{
vec4 l9_2;
Node70_If_else(0.0,vec4(1.0),vec4(0.0),l9_2,l9_0);
vec4 l9_3=l9_2;
vec2 l9_4;
Node40_If_else(0.0,vec2(0.0),Port_Default_N040,l9_4,l9_0);
vec2 l9_5;
Node8_Preview(abs(((((varTex01.xy-Port_Center_N013)*Port_Scale_N013)+Port_Center_N013)*l9_4)-(((Port_Value_N002+vec2(0.001))-vec2(0.001))*l9_4))-((clamp(boxBounds,Port_Input1_N089,Port_Input2_N089)-((vec2(Port_Input0_N036)/l9_4)*vec2(cornerRadius)))*l9_4),l9_5,l9_0);
float l9_6;
Node10_Preview(length(max(l9_5,Port_Input1_N028))-cornerRadius,l9_6,l9_0);
float l9_7=l9_6;
float l9_8=smoothstep(Port_Input0_N038,Port_Input1_N038,l9_7)*smoothstep(((Port_Value_N061+0.001)-0.001)+strokeThickness,strokeThickness,l9_7);
...
if (l9_10&&(27==PreviewNodeID))
{
PreviewInfo.Saved=true;
PreviewInfo.Color=vec4(l9_8,l9_8,l9_8,1.0);
PreviewInfo.Color.w=1.0;
}
l9_1=mix(l9_3,strokeColor,vec4(l9_8));
}
#else
{
vec4 l9_11;
Node70_If_else(0.0,vec4(1.0),vec4(0.0),l9_11,l9_0);
l9_1=l9_11;
}
#endif
...
{
l9_14=clamp(l9_1.w*2.0,0.0,1.0);
}
#else
{
float l9_15;
...
{
l9_15=clamp(dot(l9_1.xyz,vec3(l9_1.w)),0.0,1.0);
}
#else
{
float l9_16;
...
{
l9_17=(1.0-dot(l9_1.xyz,vec3(0.33333001)))*l9_1.w;
}
#else
{
float l9_18;
...
{
l9_18=(1.0-clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0))*l9_1.w;
}
#else
{
float l9_19;
...
{
l9_19=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0)*l9_1.w;
}
#else
{
float l9_20;
#if (sc_BlendMode_Add)
{
l9_20=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_21;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_21=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0)*l9_1.w;
}
#else
{
float l9_22;
...
{
l9_22=dot(l9_1.xyz,vec3(0.33333001))*l9_1.w;
}
#else
{
float l9_23;
#if (sc_BlendMode_Min)
{
l9_23=1.0-clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_24;
...
#endif
l9_12=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_1.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_13);
}
#else
{
vec4 l9_25;
...
#endif
vec3 l9_30=mix(l9_27.xyz,definedBlend(l9_27.xyz,l9_1.xyz).xyz,vec3(l9_1.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_35=vec4(mix(vec3(1.0),l9_1.xyz,vec3(l9_1.w)),l9_1.w);
}
#else
{
vec4 l9_36;
...
#endif
l9_36=vec4(l9_1.xyz*l9_37,l9_37);
}
#else
{
l9_36=l9_1;
