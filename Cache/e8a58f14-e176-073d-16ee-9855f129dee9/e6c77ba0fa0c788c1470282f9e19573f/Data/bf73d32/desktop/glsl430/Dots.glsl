...
//texture texture2DArray Tweak_N1ArrSC 0:25:0:16
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N1 75 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 76 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N1 77 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 78 -1
//spec_const int Tweak_N1Layout 79 0
...
uniform float Port_Value1_N010;
uniform float Port_Value2_N010;
uniform float Port_Input1_N017;
uniform float Port_Value1_N015;
uniform float Port_Value2_N015;
...
l9_9=varTangent.xyz;
l9_8=varNormalAndMotion.xyz;
l9_7=(sc_ModelMatrix*vec4(((sc_ModelMatrixInverse*vec4(varPosAndMotion.xyz,1.0)).xyz*vec3(Port_Value1_N010,Port_Value2_N010,Length))+vec3(Port_Value1_N015,Port_Value2_N015,Length*Port_Input1_N017),1.0)).xyz;
}
...
uniform vec3 Port_Default_N024;
uniform float Port_Default_N027;
uniform int PreviewEnabled;
...
in vec4 varColor;
void Node5_Switch(float Switch,float Value0,float Value1,float Default,out float Result,ssGlobals Globals)
{
...
#endif
ssGlobals l9_0=ssGlobals(sc_Time.x,sc_Time.y,0.0,varTex01.xy);
float l9_1=floor(float(AnimationSwitch));
bool l9_2=l9_1==0.0;
vec3 l9_3;
if (l9_2)
{
...
{
float l9_5;
Node5_Switch(0.0,Port_Value0_N005,0.0,Port_Default_N005,l9_5,l9_0);
l9_4=mix(WhiteColor,YellowColor,vec4(sin((varTex01.y+l9_5)*Port_Input1_N031))).xyz;
}
else
{
l9_4=Port_Default_N024;
}
l9_3=l9_4;
}
float l9_6;
if (l9_2)
{
vec2 l9_7=(((((varTex01.xy-Port_Center_N018)*Port_Scale_N018)+Port_Center_N018)-Port_Center_N012)*vec2(Port_Value1_N013,Length))+Port_Center_N012;
vec4 l9_8;
#if (Tweak_N1Layout==2)
{
...
vec4 l9_31=texture(Tweak_N1ArrSC,l9_30,0.0);
vec4 l9_32;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
...
vec4 l9_55=texture(Tweak_N1,l9_54.xy,0.0);
vec4 l9_56;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
...
if (l9_1==1.0)
{
vec2 l9_58=(((((varTex01.xy-Port_Center_N018)*Port_Scale_N018)+Port_Center_N018)-Port_Center_N012)*vec2(Port_Value1_N013,Length))+Port_Center_N012;
vec4 l9_59;
#if (Tweak_N1Layout==2)
{
bool l9_60=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N1)!=0));
float l9_61=l9_58.x;
sc_SoftwareWrapEarly(l9_61,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x);
float l9_62=l9_61;
float l9_63=l9_58.y;
sc_SoftwareWrapEarly(l9_63,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y);
float l9_64=l9_63;
vec2 l9_65;
float l9_66;
#if (SC_USE_UV_MIN_MAX_Tweak_N1)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_67=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x==3;
}
#else
{
...
float l9_68=l9_62;
float l9_69=1.0;
sc_ClampUV(l9_68,Tweak_N1UvMinMax.x,Tweak_N1UvMinMax.z,l9_67,l9_69);
float l9_70=l9_68;
float l9_71=l9_69;
bool l9_72;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_72=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y==3;
}
#else
{
l9_72=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0);
}
#endif
float l9_73=l9_64;
float l9_74=l9_71;
sc_ClampUV(l9_73,Tweak_N1UvMinMax.y,Tweak_N1UvMinMax.w,l9_72,l9_74);
l9_66=l9_74;
...
#endif
vec2 l9_75=sc_TransformUV(l9_65,(int(SC_USE_UV_TRANSFORM_Tweak_N1)!=0),Tweak_N1Transform);
float l9_76=l9_75.x;
float l9_77=l9_66;
sc_SoftwareWrapLate(l9_76,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x,l9_60,l9_77);
float l9_78=l9_75.y;
float l9_79=l9_77;
sc_SoftwareWrapLate(l9_78,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y,l9_60,l9_79);
float l9_80=l9_79;
vec3 l9_81=sc_SamplingCoordsViewToGlobal(vec2(l9_76,l9_78),Tweak_N1Layout,Tweak_N1GetStereoViewIndex());
vec4 l9_82=texture(Tweak_N1ArrSC,l9_81,0.0);
vec4 l9_83;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_83=mix(Tweak_N1BorderColor,l9_82,vec4(l9_80));
}
#else
{
l9_83=l9_82;
...
#else
{
bool l9_84=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N1)!=0));
float l9_85=l9_58.x;
sc_SoftwareWrapEarly(l9_85,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x);
float l9_86=l9_85;
float l9_87=l9_58.y;
sc_SoftwareWrapEarly(l9_87,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y);
float l9_88=l9_87;
vec2 l9_89;
float l9_90;
#if (SC_USE_UV_MIN_MAX_Tweak_N1)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_91=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x==3;
}
#else
{
l9_91=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0);
}
#endif
float l9_92=l9_86;
float l9_93=1.0;
sc_ClampUV(l9_92,Tweak_N1UvMinMax.x,Tweak_N1UvMinMax.z,l9_91,l9_93);
float l9_94=l9_92;
float l9_95=l9_93;
bool l9_96;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_96=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y==3;
}
#else
{
l9_96=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0);
}
#endif
float l9_97=l9_88;
float l9_98=l9_95;
sc_ClampUV(l9_97,Tweak_N1UvMinMax.y,Tweak_N1UvMinMax.w,l9_96,l9_98);
l9_90=l9_98;
...
#endif
vec2 l9_99=sc_TransformUV(l9_89,(int(SC_USE_UV_TRANSFORM_Tweak_N1)!=0),Tweak_N1Transform);
float l9_100=l9_99.x;
float l9_101=l9_90;
sc_SoftwareWrapLate(l9_100,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x,l9_84,l9_101);
float l9_102=l9_99.y;
float l9_103=l9_101;
sc_SoftwareWrapLate(l9_102,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y,l9_84,l9_103);
float l9_104=l9_103;
vec3 l9_105=sc_SamplingCoordsViewToGlobal(vec2(l9_100,l9_102),Tweak_N1Layout,Tweak_N1GetStereoViewIndex());
vec4 l9_106=texture(Tweak_N1,l9_105.xy,0.0);
vec4 l9_107;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_107=mix(Tweak_N1BorderColor,l9_106,vec4(l9_104));
}
#else
{
l9_107=l9_106;
...
#if (Tweak_N1Layout==2)
{
bool l9_109=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N1)!=0));
float l9_110=l9_58.x;
sc_SoftwareWrapEarly(l9_110,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x);
float l9_111=l9_110;
float l9_112=l9_58.y;
sc_SoftwareWrapEarly(l9_112,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y);
float l9_113=l9_112;
vec2 l9_114;
float l9_115;
#if (SC_USE_UV_MIN_MAX_Tweak_N1)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_116=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x==3;
}
#else
{
l9_116=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0);
}
#endif
float l9_117=l9_111;
float l9_118=1.0;
sc_ClampUV(l9_117,Tweak_N1UvMinMax.x,Tweak_N1UvMinMax.z,l9_116,l9_118);
float l9_119=l9_117;
float l9_120=l9_118;
bool l9_121;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_121=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y==3;
}
#else
{
l9_121=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0);
}
#endif
float l9_122=l9_113;
float l9_123=l9_120;
sc_ClampUV(l9_122,Tweak_N1UvMinMax.y,Tweak_N1UvMinMax.w,l9_121,l9_123);
l9_115=l9_123;
...
#endif
vec2 l9_124=sc_TransformUV(l9_114,(int(SC_USE_UV_TRANSFORM_Tweak_N1)!=0),Tweak_N1Transform);
float l9_125=l9_124.x;
float l9_126=l9_115;
sc_SoftwareWrapLate(l9_125,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x,l9_109,l9_126);
float l9_127=l9_124.y;
float l9_128=l9_126;
sc_SoftwareWrapLate(l9_127,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y,l9_109,l9_128);
float l9_129=l9_128;
vec3 l9_130=sc_SamplingCoordsViewToGlobal(vec2(l9_125,l9_127),Tweak_N1Layout,Tweak_N1GetStereoViewIndex());
vec4 l9_131=texture(Tweak_N1ArrSC,l9_130,0.0);
vec4 l9_132;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_132=mix(Tweak_N1BorderColor,l9_131,vec4(l9_129));
}
#else
{
l9_132=l9_131;
...
#else
{
bool l9_133=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N1)!=0));
float l9_134=l9_58.x;
sc_SoftwareWrapEarly(l9_134,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x);
float l9_135=l9_134;
float l9_136=l9_58.y;
sc_SoftwareWrapEarly(l9_136,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y);
float l9_137=l9_136;
vec2 l9_138;
float l9_139;
#if (SC_USE_UV_MIN_MAX_Tweak_N1)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_140=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x==3;
}
#else
{
l9_140=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0);
}
#endif
float l9_141=l9_135;
float l9_142=1.0;
sc_ClampUV(l9_141,Tweak_N1UvMinMax.x,Tweak_N1UvMinMax.z,l9_140,l9_142);
float l9_143=l9_141;
float l9_144=l9_142;
bool l9_145;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_145=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y==3;
}
#else
{
l9_145=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0);
}
#endif
float l9_146=l9_137;
float l9_147=l9_144;
sc_ClampUV(l9_146,Tweak_N1UvMinMax.y,Tweak_N1UvMinMax.w,l9_145,l9_147);
l9_139=l9_147;
...
#endif
vec2 l9_148=sc_TransformUV(l9_138,(int(SC_USE_UV_TRANSFORM_Tweak_N1)!=0),Tweak_N1Transform);
float l9_149=l9_148.x;
float l9_150=l9_139;
sc_SoftwareWrapLate(l9_149,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x,l9_133,l9_150);
float l9_151=l9_148.y;
float l9_152=l9_150;
sc_SoftwareWrapLate(l9_151,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y,l9_133,l9_152);
float l9_153=l9_152;
vec3 l9_154=sc_SamplingCoordsViewToGlobal(vec2(l9_149,l9_151),Tweak_N1Layout,Tweak_N1GetStereoViewIndex());
vec4 l9_155=texture(Tweak_N1,l9_154.xy,0.0);
vec4 l9_156;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_156=mix(Tweak_N1BorderColor,l9_155,vec4(l9_153));
}
#else
{
l9_156=l9_155;
...
#endif
float l9_157;
Node5_Switch(0.0,Port_Value0_N005,0.0,Port_Default_N005,l9_157,l9_0);
l9_57=mix(l9_59.y,l9_108.x,sin((varTex01.y+l9_157)*Port_Input1_N031));
}
else
{
l9_57=Port_Default_N027;
}
l9_6=l9_57;
}
vec4 l9_158=vec4(l9_3.x,l9_3.y,l9_3.z,vec4(0.0).w);
l9_158.w=l9_6;
...
{
l9_162=clamp(dot(l9_158.xyz,vec3(l9_6)),0.0,1.0);
}
#else
{
float l9_163;
...
{
l9_164=(1.0-dot(l9_158.xyz,vec3(0.33333001)))*l9_6;
}
#else
{
float l9_165;
...
{
l9_165=(1.0-clamp(dot(l9_158.xyz,vec3(1.0)),0.0,1.0))*l9_6;
}
#else
{
float l9_166;
...
{
l9_166=clamp(dot(l9_158.xyz,vec3(1.0)),0.0,1.0)*l9_6;
}
#else
{
float l9_167;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_168=clamp(dot(l9_158.xyz,vec3(1.0)),0.0,1.0)*l9_6;
}
#else
{
float l9_169;
...
{
l9_169=dot(l9_158.xyz,vec3(0.33333001))*l9_6;
}
#else
{
float l9_170;
...
#endif
vec3 l9_177=mix(l9_174.xyz,definedBlend(l9_174.xyz,l9_158.xyz).xyz,vec3(l9_6));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_182=vec4(mix(vec3(1.0),l9_158.xyz,vec3(l9_6)),l9_6);
}
#else
{
vec4 l9_183;
