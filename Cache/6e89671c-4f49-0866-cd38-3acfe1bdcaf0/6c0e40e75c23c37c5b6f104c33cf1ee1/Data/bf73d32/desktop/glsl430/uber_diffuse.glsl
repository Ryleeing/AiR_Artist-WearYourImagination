...
//spec_const bool SC_USE_CLAMP_TO_BORDER_materialParamsTex 46 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_normalTex 47 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_opacityTex 48 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_reflectionModulationTex 49 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_reflectionTex 50 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_rimColorTex 51 0
//spec_const bool SC_USE_UV_MIN_MAX_baseTex 52 0
//spec_const bool SC_USE_UV_MIN_MAX_detailNormalTex 53 0
//spec_const bool SC_USE_UV_MIN_MAX_emissiveTex 54 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 55 0
//spec_const bool SC_USE_UV_MIN_MAX_materialParamsTex 56 0
//spec_const bool SC_USE_UV_MIN_MAX_normalTex 57 0
//spec_const bool SC_USE_UV_MIN_MAX_opacityTex 58 0
//spec_const bool SC_USE_UV_MIN_MAX_reflectionModulationTex 59 0
//spec_const bool SC_USE_UV_MIN_MAX_reflectionTex 60 0
//spec_const bool SC_USE_UV_MIN_MAX_rimColorTex 61 0
//spec_const bool SC_USE_UV_TRANSFORM_baseTex 62 0
//spec_const bool SC_USE_UV_TRANSFORM_detailNormalTex 63 0
//spec_const bool SC_USE_UV_TRANSFORM_emissiveTex 64 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 65 0
//spec_const bool SC_USE_UV_TRANSFORM_materialParamsTex 66 0
...
//spec_const bool Tweak_N177 72 0
//spec_const bool Tweak_N216 73 0
...
//spec_const bool sc_BlendMode_Add 85 0
...
//spec_const bool sc_BlendMode_Multiply 93 0
...
//spec_const bool sc_OITDepthPrepass 111 0
//spec_const bool sc_OITFrontLayerPass 112 0
//spec_const bool sc_OITMaxLayers4Plus1 113 0
//spec_const bool sc_OITMaxLayers8 114 0
//spec_const bool sc_OITMaxLayersVisualizeLayerCount 115 0
//spec_const bool sc_OutputBounds 116 0
//spec_const bool sc_ProjectiveShadowsCaster 117 0
//spec_const bool sc_ProjectiveShadowsReceiver 118 0
//spec_const bool sc_RayTracingCasterForceOpaque 119 0
//spec_const bool sc_RayTracingGlobalIlluminationHasSwappedViews 120 0
//spec_const bool sc_RayTracingShadowsHasSwappedViews 121 0
...
//spec_const bool sc_Voxelization 128 0
...
//spec_const int sc_RayTracingGlobalIlluminationLayout 188 0
...
//spec_const int sc_StereoViewID 196 0
//SG_REFLECTION_END
...
#if (materialParamsTexLayout==2)
{
bool l9_454=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0));
float l9_455=l9_452.x;
sc_SoftwareWrapEarly(l9_455,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_456=l9_455;
float l9_457=l9_452.y;
sc_SoftwareWrapEarly(l9_457,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_458=l9_457;
vec2 l9_459;
float l9_460;
#if (SC_USE_UV_MIN_MAX_materialParamsTex)
...
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_461=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_461=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_462=l9_456;
float l9_463=1.0;
sc_ClampUV(l9_462,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_461,l9_463);
float l9_464=l9_462;
float l9_465=l9_463;
bool l9_466;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_466=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
l9_466=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_467=l9_458;
float l9_468=l9_465;
sc_ClampUV(l9_467,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_466,l9_468);
l9_460=l9_468;
...
#endif
vec2 l9_469=sc_TransformUV(l9_459,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_470=l9_469.x;
float l9_471=l9_460;
sc_SoftwareWrapLate(l9_470,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,l9_454,l9_471);
float l9_472=l9_469.y;
float l9_473=l9_471;
sc_SoftwareWrapLate(l9_472,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,l9_454,l9_473);
float l9_474=l9_473;
vec3 l9_475=sc_SamplingCoordsViewToGlobal(vec2(l9_470,l9_472),materialParamsTexLayout,materialParamsTexGetStereoViewIndex());
vec4 l9_476=texture(materialParamsTexArrSC,l9_475,0.0);
vec4 l9_477;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_477=mix(materialParamsTexBorderColor,l9_476,vec4(l9_474));
}
#else
{
l9_477=l9_476;
...
#else
{
bool l9_478=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0));
float l9_479=l9_452.x;
sc_SoftwareWrapEarly(l9_479,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_480=l9_479;
float l9_481=l9_452.y;
sc_SoftwareWrapEarly(l9_481,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_482=l9_481;
vec2 l9_483;
float l9_484;
#if (SC_USE_UV_MIN_MAX_materialParamsTex)
...
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_485=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
...
float l9_486=l9_480;
float l9_487=1.0;
sc_ClampUV(l9_486,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_485,l9_487);
float l9_488=l9_486;
float l9_489=l9_487;
bool l9_490;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_490=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
l9_490=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_491=l9_482;
float l9_492=l9_489;
sc_ClampUV(l9_491,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_490,l9_492);
l9_484=l9_492;
...
#endif
vec2 l9_493=sc_TransformUV(l9_483,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_494=l9_493.x;
float l9_495=l9_484;
sc_SoftwareWrapLate(l9_494,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,l9_478,l9_495);
float l9_496=l9_493.y;
float l9_497=l9_495;
sc_SoftwareWrapLate(l9_496,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,l9_478,l9_497);
float l9_498=l9_497;
vec3 l9_499=sc_SamplingCoordsViewToGlobal(vec2(l9_494,l9_496),materialParamsTexLayout,materialParamsTexGetStereoViewIndex());
vec4 l9_500=texture(materialParamsTex,l9_499.xy,0.0);
vec4 l9_501;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_501=mix(materialParamsTexBorderColor,l9_500,vec4(l9_498));
}
#else
{
l9_501=l9_500;
...
{
l9_502=vec3(l9_453.z)*tempGlobals.VertexColor.xyz;
}
else
{
l9_502=vec3(l9_453.z);
}
vec3 l9_503;
#if (!sc_ProjectiveShadowsCaster)
{
...
#endif
float l9_504=clamp(l9_124,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
...
#endif
vec3 l9_505=max(l9_123.xyz,vec3(0.0));
vec4 l9_506;
#if (sc_ProjectiveShadowsCaster)
{
...
#else
{
l9_506=ngsCalculateLighting(l9_505,l9_504,l9_503,l9_8,l9_9,max(l9_451,vec3(0.0)),0.0,1.0,clamp(l9_502,vec3(0.0),vec3(1.0)),vec3(1.0));
}
#endif
...
#endif
sc_writeFragData0(max(l9_508,vec4(0.0)));
return;
}
vec4 l9_510;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_Voxelization)
{
l9_528=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_529;
#if (sc_OutputBounds)
{
float l9_530=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_529=vec4(l9_530,1.0-l9_530,1.0,1.0);
}
#else
{
vec4 l9_531;
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_532=l9_507.w;
l9_531=vec4(mix(vec3(1.0),l9_507.xyz,vec3(l9_532)),l9_532);
}
#else
{
vec4 l9_533;
...
{
float l9_534=l9_507.w;
float l9_535;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_535=clamp(l9_534,0.0,1.0);
}
#else
{
l9_535=l9_534;
...
#endif
l9_533=vec4(l9_507.xyz*l9_535,l9_535);
}
#else
{
l9_533=l9_507;
...
vec4 l9_538=sc_OutputMotionVectorIfNeeded(max(l9_536,vec4(0.0)));
vec4 l9_539=clamp(l9_538,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_540=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_540-0.0039215689)),min(1.0,l9_540+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_541=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_541).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_542=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_541).xy);
float l9_543=packValue(l9_542);
int l9_550=int(l9_539.w*255.0);
float l9_551=packValue(l9_550);
sc_writeFragData0(vec4(packValue(l9_542),packValue(l9_542),packValue(l9_542),packValue(l9_542)));
}
#endif
}
#else
...
#if (sc_OITCompositingPass)
{
vec2 l9_554=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_554).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_559==0)
{
l9_562=texture(sc_OITAlpha0,l9_554);
l9_561=texture(sc_OITDepthLow0,l9_554);
l9_560=texture(sc_OITDepthHigh0,l9_554);
}
else
{
l9_562=vec4(0.0);
...
if (l9_559==1)
{
l9_565=texture(sc_OITAlpha1,l9_554);
l9_564=texture(sc_OITDepthLow1,l9_554);
l9_563=texture(sc_OITDepthHigh1,l9_554);
}
else
{
l9_565=l9_562;
...
if (any(notEqual(l9_563,vec4(0.0)))||any(notEqual(l9_564,vec4(0.0))))
{
int l9_566[8]=l9_555;
unpackValues(l9_563.w,l9_559,l9_566);
unpackValues(l9_563.z,l9_559,l9_566);
unpackValues(l9_563.y,l9_559,l9_566);
unpackValues(l9_563.x,l9_559,l9_566);
unpackValues(l9_564.w,l9_559,l9_566);
unpackValues(l9_564.z,l9_559,l9_566);
unpackValues(l9_564.y,l9_559,l9_566);
unpackValues(l9_564.x,l9_559,l9_566);
int l9_575[8]=l9_556;
unpackValues(l9_565.w,l9_559,l9_575);
unpackValues(l9_565.z,l9_559,l9_575);
unpackValues(l9_565.y,l9_559,l9_575);
unpackValues(l9_565.x,l9_559,l9_575);
}
l9_559++;
continue;
}
...
vec4 l9_580=texture(sc_OITFilteredDepthBoundsTexture,l9_554);
vec2 l9_581=l9_580.xy;
int l9_582;
#if (sc_SkinBonesCount>0)
{
l9_582=encodeDepth(((1.0-l9_580.x)*1000.0)+getDepthOrderingEpsilon(),l9_581);
}
#else
{
l9_582=0;
...
#endif
int l9_583=encodeDepth(viewSpaceDepth(),l9_581);
vec4 l9_584;
l9_584=l9_539*l9_539.w;
vec4 l9_585;
int l9_586=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_586<8)
{
int l9_587=l9_555[l9_586];
int l9_588=l9_583-l9_582;
bool l9_589=l9_587<l9_588;
bool l9_590;
if (l9_589)
{
l9_590=l9_555[l9_586]>0;
}
else
{
l9_590=l9_589;
...
if (l9_590)
{
vec3 l9_591=l9_584.xyz*(1.0-(float(l9_556[l9_586])/255.0));
l9_585=vec4(l9_591.x,l9_591.y,l9_591.z,l9_584.w);
}
else
{
l9_585=l9_584;
