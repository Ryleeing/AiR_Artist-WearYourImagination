...
float l9_169=max((((((mix(l9_52.x,l9_101.y,clamp((((clamp((smoothstep(l9_153,l9_155+l9_153,l9_27)-smoothstep(l9_151,l9_155+l9_151,l9_27))+0.001,Port_Input1_N051+0.001,Port_Input2_N051+0.001)-0.001)*l9_156)*Port_Input1_N101)+0.001,Port_Input1_N102+0.001,Port_Input2_N102+0.001)-0.001)+Port_Input1_N069)*(smoothstep(Port_Input0_N026,Port_Input1_N026,l9_27)*(1.0-smoothstep(l9_157,l9_157+Port_Input1_N020,l9_158))))*Port_Input2_N006)*((((smoothstep(Port_Input0_N103,(((switchSize-Port_RangeMinA_N148)/((Port_RangeMaxA_N148-Port_RangeMinA_N148)+1e-06))*(Port_RangeMaxB_N148-Port_RangeMinB_N148))+Port_RangeMinB_N148,l9_27)-Port_RangeMinA_N105)/((Port_RangeMaxA_N105-Port_RangeMinA_N105)+1e-06))*(Port_RangeMaxB_N105-Port_RangeMinB_N105))+Port_RangeMinB_N105))+l9_28)+Port_Input2_N027,l9_160);
vec4 l9_170=vec4(l9_41.x,l9_41.y,l9_41.z,vec4(0.0).w);
l9_170.w=l9_169;
if ((float(l9_169==Port_Input1_N064)*1.0)!=0.0)
{
discard;
}
...
#endif
sc_writeFragData0(max(l9_171,vec4(0.0)));
return;
}
vec4 l9_173;
...
{
l9_175=clamp(l9_169*2.0,0.0,1.0);
}
#else
{
float l9_176;
...
{
l9_176=clamp(dot(l9_170.xyz,vec3(l9_169)),0.0,1.0);
}
#else
{
float l9_177;
...
{
l9_178=(1.0-dot(l9_170.xyz,vec3(0.33333001)))*l9_169;
}
#else
{
float l9_179;
...
{
l9_179=(1.0-clamp(dot(l9_170.xyz,vec3(1.0)),0.0,1.0))*l9_169;
}
#else
{
float l9_180;
...
{
l9_180=clamp(dot(l9_170.xyz,vec3(1.0)),0.0,1.0)*l9_169;
}
#else
{
float l9_181;
#if (sc_BlendMode_Add)
{
l9_181=clamp(dot(l9_170.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_182;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_182=clamp(dot(l9_170.xyz,vec3(1.0)),0.0,1.0)*l9_169;
}
#else
{
float l9_183;
...
{
l9_183=dot(l9_170.xyz,vec3(0.33333001))*l9_169;
}
#else
{
float l9_184;
#if (sc_BlendMode_Min)
{
l9_184=1.0-clamp(dot(l9_170.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_185;
#if (sc_BlendMode_Max)
{
l9_185=clamp(dot(l9_170.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_185=1.0;
...
#endif
l9_173=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_170.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_174);
}
#else
{
vec4 l9_186;
...
{
l9_190=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_189,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_190=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_189,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_188=l9_190;
}
#endif
vec3 l9_191=mix(l9_188.xyz,definedBlend(l9_188.xyz,l9_170.xyz).xyz,vec3(l9_169));
...
#if (sc_Voxelization)
{
l9_193=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_194;
#if (sc_OutputBounds)
{
float l9_195=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_194=vec4(l9_195,1.0-l9_195,1.0,1.0);
}
#else
{
vec4 l9_196;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_196=vec4(mix(vec3(1.0),l9_170.xyz,vec3(l9_169)),l9_169);
}
#else
{
vec4 l9_197;
...
#endif
l9_197=vec4(l9_170.xyz*l9_198,l9_198);
}
#else
{
l9_197=l9_170;
...
vec4 l9_201=sc_OutputMotionVectorIfNeeded(max(l9_199,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_203-0.0039215689)),min(1.0,l9_203+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#endif
int l9_205=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_204).xy);
float l9_206=packValue(l9_205);
int l9_213=int(l9_202.w*255.0);
float l9_214=packValue(l9_213);
sc_writeFragData0(vec4(packValue(l9_205),packValue(l9_205),packValue(l9_205),packValue(l9_205)));
}
#endif
}
#else
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_217).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_222==0)
{
l9_225=texture(sc_OITAlpha0,l9_217);
l9_224=texture(sc_OITDepthLow0,l9_217);
l9_223=texture(sc_OITDepthHigh0,l9_217);
}
else
{
l9_225=vec4(0.0);
...
if (l9_222==1)
{
l9_228=texture(sc_OITAlpha1,l9_217);
l9_227=texture(sc_OITDepthLow1,l9_217);
l9_226=texture(sc_OITDepthHigh1,l9_217);
}
else
{
l9_228=l9_225;
...
vec4 l9_243=texture(sc_OITFilteredDepthBoundsTexture,l9_217);
