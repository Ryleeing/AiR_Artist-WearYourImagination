...
l9_6=l9_11;
l9_5=l9_12;
l9_4=cross(l9_12,l9_11)*varTangent.w;
l9_3=normalize(sc_Camera.position-varPosAndMotion.xyz);
l9_2=varTex01.xy;
l9_1=varTex01.zw;
}
mat3 l9_13=mat3(l9_6,l9_4,l9_5);
vec3 l9_14=-l9_3;
float l9_15=max(pow(1.0-abs(dot(l9_14,l9_13*Port_Normal_N041)),Tweak_N44),0.0)*fadeLevel;
vec4 l9_16;
#if (Tweak_N6Layout==2)
{
bool l9_17=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0));
float l9_18=l9_2.x;
sc_SoftwareWrapEarly(l9_18,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x);
float l9_19=l9_18;
float l9_20=l9_2.y;
sc_SoftwareWrapEarly(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y);
float l9_21=l9_20;
vec2 l9_22;
float l9_23;
...
{
l9_24=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x==3;
}
#else
{
l9_24=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_25=l9_19;
float l9_26=1.0;
sc_ClampUV(l9_25,Tweak_N6UvMinMax.x,Tweak_N6UvMinMax.z,l9_24,l9_26);
float l9_27=l9_25;
float l9_28=l9_26;
bool l9_29;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_29=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y==3;
}
#else
{
l9_29=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_30=l9_21;
float l9_31=l9_28;
sc_ClampUV(l9_30,Tweak_N6UvMinMax.y,Tweak_N6UvMinMax.w,l9_29,l9_31);
l9_23=l9_31;
...
#endif
vec2 l9_32=sc_TransformUV(l9_22,(int(SC_USE_UV_TRANSFORM_Tweak_N6)!=0),Tweak_N6Transform);
float l9_33=l9_32.x;
float l9_34=l9_23;
sc_SoftwareWrapLate(l9_33,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x,l9_17,l9_34);
float l9_35=l9_32.y;
float l9_36=l9_34;
sc_SoftwareWrapLate(l9_35,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y,l9_17,l9_36);
float l9_37=l9_36;
vec3 l9_38=sc_SamplingCoordsViewToGlobal(vec2(l9_33,l9_35),Tweak_N6Layout,Tweak_N6GetStereoViewIndex());
vec4 l9_39=texture(Tweak_N6ArrSC,l9_38,0.0);
vec4 l9_40;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_40=mix(Tweak_N6BorderColor,l9_39,vec4(l9_37));
}
#else
{
l9_40=l9_39;
...
#else
{
bool l9_41=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0));
float l9_42=l9_2.x;
...
float l9_57=l9_56.x;
float l9_58=l9_47;
sc_SoftwareWrapLate(l9_57,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x,l9_41,l9_58);
float l9_59=l9_56.y;
float l9_60=l9_58;
sc_SoftwareWrapLate(l9_59,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y,l9_41,l9_60);
float l9_61=l9_60;
vec3 l9_62=sc_SamplingCoordsViewToGlobal(vec2(l9_57,l9_59),Tweak_N6Layout,Tweak_N6GetStereoViewIndex());
vec4 l9_63=texture(Tweak_N6,l9_62.xy,0.0);
vec4 l9_64;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
...
#endif
vec4 l9_65=Port_Value_N017+l9_16;
vec4 l9_66=l9_65*l9_16;
vec4 l9_67=vec4(l9_15);
vec3 l9_68=l9_67.xyz*l9_15;
vec4 l9_69;
#if (Tweak_N0Layout==2)
{
bool l9_70=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0));
float l9_71=l9_1.x;
sc_SoftwareWrapEarly(l9_71,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x);
float l9_72=l9_71;
float l9_73=l9_1.y;
sc_SoftwareWrapEarly(l9_73,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y);
float l9_74=l9_73;
vec2 l9_75;
float l9_76;
...
{
l9_77=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x==3;
}
#else
{
l9_77=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_78=l9_72;
float l9_79=1.0;
sc_ClampUV(l9_78,Tweak_N0UvMinMax.x,Tweak_N0UvMinMax.z,l9_77,l9_79);
float l9_80=l9_78;
float l9_81=l9_79;
bool l9_82;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_82=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y==3;
}
#else
{
l9_82=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_83=l9_74;
float l9_84=l9_81;
sc_ClampUV(l9_83,Tweak_N0UvMinMax.y,Tweak_N0UvMinMax.w,l9_82,l9_84);
l9_76=l9_84;
...
#endif
vec2 l9_85=sc_TransformUV(l9_75,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform);
float l9_86=l9_85.x;
float l9_87=l9_76;
sc_SoftwareWrapLate(l9_86,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x,l9_70,l9_87);
float l9_88=l9_85.y;
float l9_89=l9_87;
sc_SoftwareWrapLate(l9_88,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y,l9_70,l9_89);
float l9_90=l9_89;
vec3 l9_91=sc_SamplingCoordsViewToGlobal(vec2(l9_86,l9_88),Tweak_N0Layout,Tweak_N0GetStereoViewIndex());
vec4 l9_92=texture(Tweak_N0ArrSC,l9_91,0.0);
vec4 l9_93;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_93=mix(Tweak_N0BorderColor,l9_92,vec4(l9_90));
}
#else
{
l9_93=l9_92;
...
#else
{
bool l9_94=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0));
float l9_95=l9_1.x;
sc_SoftwareWrapEarly(l9_95,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x);
float l9_96=l9_95;
float l9_97=l9_1.y;
sc_SoftwareWrapEarly(l9_97,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y);
float l9_98=l9_97;
vec2 l9_99;
float l9_100;
#if (SC_USE_UV_MIN_MAX_Tweak_N0)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_101=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x==3;
}
#else
{
...
float l9_102=l9_96;
float l9_103=1.0;
sc_ClampUV(l9_102,Tweak_N0UvMinMax.x,Tweak_N0UvMinMax.z,l9_101,l9_103);
float l9_104=l9_102;
float l9_105=l9_103;
bool l9_106;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_106=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y==3;
}
#else
{
l9_106=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_107=l9_98;
float l9_108=l9_105;
sc_ClampUV(l9_107,Tweak_N0UvMinMax.y,Tweak_N0UvMinMax.w,l9_106,l9_108);
l9_100=l9_108;
...
#endif
vec2 l9_109=sc_TransformUV(l9_99,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform);
float l9_110=l9_109.x;
float l9_111=l9_100;
sc_SoftwareWrapLate(l9_110,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x,l9_94,l9_111);
float l9_112=l9_109.y;
float l9_113=l9_111;
sc_SoftwareWrapLate(l9_112,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y,l9_94,l9_113);
float l9_114=l9_113;
vec3 l9_115=sc_SamplingCoordsViewToGlobal(vec2(l9_110,l9_112),Tweak_N0Layout,Tweak_N0GetStereoViewIndex());
vec4 l9_116=texture(Tweak_N0,l9_115.xy,0.0);
vec4 l9_117;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_117=mix(Tweak_N0BorderColor,l9_116,vec4(l9_114));
}
#else
{
l9_117=l9_116;
...
#endif
vec4 l9_118=l9_69*vec4(opacityIntensity);
float l9_119=l9_118.x;
vec4 l9_120=vec4(min(vec4(l9_68.x,l9_68.y,l9_68.z,l9_67.w)+((l9_66*Port_Value_N017)*vec4(glowIntensity)),vec4(1.0)).xyz,l9_119);
...
{
l9_125=clamp(l9_119*2.0,0.0,1.0);
}
#else
{
float l9_126;
...
{
l9_126=clamp(dot(l9_120.xyz,vec3(l9_119)),0.0,1.0);
}
#else
{
float l9_127;
...
{
l9_128=(1.0-dot(l9_120.xyz,vec3(0.33333001)))*l9_119;
}
#else
{
float l9_129;
...
{
l9_129=(1.0-clamp(dot(l9_120.xyz,vec3(1.0)),0.0,1.0))*l9_119;
}
#else
{
float l9_130;
...
#if (sc_BlendMode_Add)
{
l9_131=clamp(dot(l9_120.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_132;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_132=clamp(dot(l9_120.xyz,vec3(1.0)),0.0,1.0)*l9_119;
}
#else
{
float l9_133;
...
{
l9_133=dot(l9_120.xyz,vec3(0.33333001))*l9_119;
}
#else
{
float l9_134;
#if (sc_BlendMode_Min)
{
l9_134=1.0-clamp(dot(l9_120.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_135;
#if (sc_BlendMode_Max)
{
l9_135=clamp(dot(l9_120.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_135=1.0;
...
#endif
l9_123=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_120.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_124);
}
#else
{
vec4 l9_136;
...
#endif
vec3 l9_141=mix(l9_138.xyz,definedBlend(l9_138.xyz,l9_120.xyz).xyz,vec3(l9_119));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_146=vec4(mix(vec3(1.0),l9_120.xyz,vec3(l9_119)),l9_119);
}
#else
{
vec4 l9_147;
...
#endif
l9_147=vec4(l9_120.xyz*l9_148,l9_148);
}
#else
{
l9_147=l9_120;
