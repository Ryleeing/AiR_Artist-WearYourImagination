...
uniform float Port_RangeMinB_N039;
uniform int PreviewEnabled;
...
vec2 l9_4=(vec2(l9_1.xz)*Port_Input1_N015)*vec2(uvScale);
vec4 l9_5;
#if (baseTexLayout==2)
{
...
#endif
vec3 l9_54=l9_5.xyz*baseColor;
vec2 l9_55=l9_2-Port_Center_N085;
vec2 l9_56=(((l9_55*(vec2(Port_Input0_N020)/clamp(Port_Import_N091,vec2(0.0),vec2(10.0))))+Port_Center_N085)*vec2(Port_Input1_N021))-vec2(Port_Input1_N022);
float l9_57=atan(l9_56.y*Port_Input1_N024,l9_56.x);
float l9_58=(Port_Input0_N027*3.1415927)/clamp(floor(Port_Import_N028),Port_Input1_N030,Port_Input2_N030);
float l9_59=((((1.0-(cos((floor((l9_57/l9_58)+Port_Input1_N033)*l9_58)-l9_57)*length(l9_56)))-Port_RangeMinA_N039)/((clamp(Port_Import_N025,0.0,1.0)-Port_RangeMinA_N039)+1e-06))*(Port_RangeMaxB_N039-Port_RangeMinB_N039))+Port_RangeMinB_N039;
vec4 l9_60=vec4(l9_54.x,l9_54.y,l9_54.z,vec4(0.0).w);
l9_60.w=l9_59;
...
{
l9_66=clamp(dot(l9_60.xyz,vec3(l9_59)),0.0,1.0);
}
#else
{
float l9_67;
...
{
l9_68=(1.0-dot(l9_60.xyz,vec3(0.33333001)))*l9_59;
}
#else
{
float l9_69;
...
{
l9_69=(1.0-clamp(dot(l9_60.xyz,vec3(1.0)),0.0,1.0))*l9_59;
}
#else
{
float l9_70;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_72=clamp(dot(l9_60.xyz,vec3(1.0)),0.0,1.0)*l9_59;
}
#else
{
float l9_73;
...
{
l9_73=dot(l9_60.xyz,vec3(0.33333001))*l9_59;
}
#else
{
float l9_74;
...
{
l9_80=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_79,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_80=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_79,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_78=l9_80;
}
#endif
vec3 l9_81=mix(l9_78.xyz,definedBlend(l9_78.xyz,l9_60.xyz).xyz,vec3(l9_59));
...
#if (sc_Voxelization)
{
l9_83=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_84;
#if (sc_OutputBounds)
{
float l9_85=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_84=vec4(l9_85,1.0-l9_85,1.0,1.0);
}
#else
{
vec4 l9_86;
