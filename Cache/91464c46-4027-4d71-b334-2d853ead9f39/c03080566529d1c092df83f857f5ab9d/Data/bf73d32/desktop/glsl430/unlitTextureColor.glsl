...
{
l9_58=clamp(l9_3.w*2.0,0.0,1.0);
}
#else
{
float l9_59;
...
{
l9_59=clamp(dot(l9_53.xyz,vec3(l9_3.w)),0.0,1.0);
}
#else
{
float l9_60;
...
{
l9_61=(1.0-dot(l9_53.xyz,vec3(0.33333001)))*l9_3.w;
}
#else
{
float l9_62;
...
{
l9_62=(1.0-clamp(dot(l9_53.xyz,vec3(1.0)),0.0,1.0))*l9_3.w;
}
#else
{
float l9_63;
...
{
l9_63=clamp(dot(l9_53.xyz,vec3(1.0)),0.0,1.0)*l9_3.w;
}
#else
{
float l9_64;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_65=clamp(dot(l9_53.xyz,vec3(1.0)),0.0,1.0)*l9_3.w;
}
#else
{
float l9_66;
...
{
l9_66=dot(l9_53.xyz,vec3(0.33333001))*l9_3.w;
}
#else
{
float l9_67;
...
#endif
vec3 l9_74=mix(l9_71.xyz,definedBlend(l9_71.xyz,l9_53.xyz).xyz,vec3(l9_3.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_79=vec4(mix(vec3(1.0),l9_53.xyz,vec3(l9_3.w)),l9_3.w);
}
#else
{
vec4 l9_80;
