...
uniform float pinch;
uniform float poke;
uniform float SquishMultiplier;
...
vec4 l9_9=varColor;
vec4 l9_10;
if ((float(pinch>poke)*1.0)!=0.0)
{
float l9_11=l9_7.x;
float l9_12=l9_7.y;
l9_10=vec4(l9_11,l9_12+(((-l9_12)*smoothstep(0.0,1.0,pinch*(1.0-abs(l9_11))))*SquishMultiplier),l9_7.z,0.0);
}
else
{
vec3 l9_13=vec3(0.0,0.0,1.0)-l9_8;
l9_10=vec4(l9_8+((((-normalize(l9_13))*poke)*Indent)*smoothstep(1.0,0.0,length(l9_13))),0.0);
}
float l9_14=step(l9_9.z,Port_Input1_N012);
float l9_15=length(sc_ModelMatrix[0].xyz);
float l9_16=l9_15-max(Port_Input0_N023-l9_15,Port_Input1_N032);
float l9_17=max(length(sc_ModelMatrix[1].xyz),length(sc_ModelMatrix[2].xyz));
float l9_18=Port_Input0_N030/(l9_17+1.234e-06);
float l9_19=step(l9_9.x,Port_Input1_N016);
vec3 l9_20;
vec3 l9_21;
vec3 l9_22;
if (l9_4)
{
l9_22=varTangent.xyz;
l9_21=varNormalAndMotion.xyz;
l9_20=varPosAndMotion.xyz;
}
else
{
l9_22=varTangent.xyz;
l9_21=varNormalAndMotion.xyz;
l9_20=(sc_ModelMatrix*vec4((((((l9_10.x+(l9_14*Port_Input1_N013))+((l9_14*l9_16)*(l9_18*Port_Input1_N031)))+(l9_19*Port_Input1_N015))+((l9_19*l9_16)*l9_18))/(l9_15+1.234e-06))*l9_17,l9_10.yz,1.0)).xyz;
}
varPosAndMotion=vec4(l9_20.x,l9_20.y,l9_20.z,varPosAndMotion.w);
vec3 l9_23=normalize(l9_21);
varNormalAndMotion=vec4(l9_23.x,l9_23.y,l9_23.z,varNormalAndMotion.w);
vec3 l9_24=normalize(l9_22);
...
#if (sc_RenderingSpace==2)
{
l9_30=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPosAndMotion.xyz,1.0);
}
#else
{
vec4 l9_31;
#if (sc_RenderingSpace==1)
{
l9_31=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPosAndMotion.xyz,1.0);
}
#else
{
l9_31=vec4(0.0);
...
#if (sc_Voxelization)
{
sc_Vertex_t l9_39=sc_Vertex_t(l9_0.position,l9_0.normal,l9_0.tangent,l9_5,l9_0.texture1);
...
#if (sc_OutputBounds)
{
sc_Vertex_t l9_43=sc_Vertex_t(l9_0.position,l9_0.normal,l9_0.tangent,l9_5,l9_0.texture1);
sc_BlendVertex(l9_43);
sc_SkinVertex(l9_43);
vec2 l9_44=((l9_43.position.xy/vec2(l9_43.position.w))*0.5)+vec2(0.5);
varTex01=vec4(l9_44.x,l9_44.y,varTex01.z,varTex01.w);
vec4 l9_45=sc_ModelMatrixVoxelization*l9_43.position;
vec3 l9_46=l9_45.xyz-voxelization_params_camera_pos;
varPosAndMotion=vec4(l9_46.x,l9_46.y,l9_46.z,varPosAndMotion.w);
vec3 l9_47=normalize(l9_43.normal);
varNormalAndMotion=vec4(l9_47.x,l9_47.y,l9_47.z,varNormalAndMotion.w);
vec4 l9_48=createVoxelOrthoMatrix(voxelization_params_frustum_lrbt.x,voxelization_params_frustum_lrbt.y,voxelization_params_frustum_lrbt.z,voxelization_params_frustum_lrbt.w,voxelization_params_frustum_nf.x,voxelization_params_frustum_nf.y)*vec4(l9_46.x,l9_46.y,l9_46.z,l9_45.w);
...
#endif
vec4 l9_50=varPosAndMotion;
#if (sc_MotionVectorsPass)
{
vec4 l9_51=vec4(l9_50.xyz,1.0);
#if (sc_MotionVectorsPass)
{
vec4 l9_52=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*l9_51;
vec4 l9_53=sc_PrevFrameViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(((sc_PrevFrameModelMatrix*sc_ModelMatrixInverse)*l9_51).xyz,1.0);
vec2 l9_54=((l9_52.xy/vec2(l9_52.w)).xy-(l9_53.xy/vec2(l9_53.w)).xy)*0.5;
varPosAndMotion.w=l9_54.x;
varNormalAndMotion.w=l9_54.y;
}
#endif
}
#endif
