...
#endif
vec4 l9_0=vec4(normalize((sc_ModelMatrixInverse*vec4(normalize(varNormalAndMotion.xyz),0.0)).xyz),0.0);
...
{
l9_6=(1.0-dot(l9_0.xyz,vec3(0.33333001)))*0.0;
}
#else
{
float l9_7;
...
{
l9_7=(1.0-clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0))*0.0;
}
#else
{
float l9_8;
...
{
l9_8=clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0)*0.0;
}
#else
{
float l9_9;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_10=clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0)*0.0;
}
#else
{
float l9_11;
...
{
l9_11=dot(l9_0.xyz,vec3(0.33333001))*0.0;
}
#else
{
float l9_12;
...
#endif
vec4 l9_19=vec4(l9_16.x,l9_16.y,l9_16.z,vec4(0.0).w);
l9_19.w=1.0;
l9_15=l9_19;
}
#else
...
vec4 l9_27=sc_OutputMotionVectorIfNeeded(max(l9_25,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_29-0.0039215689)),min(1.0,l9_29+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_31),packValue(l9_31),packValue(l9_31),packValue(l9_31)));
}
#endif
}
#else
...
vec4 l9_69=texture(sc_OITFilteredDepthBoundsTexture,l9_43);
vec2 l9_70=l9_69.xy;
int l9_71;
#if (sc_SkinBonesCount>0)
{
