...
// @input SceneObject targetZ {"hint":"Override default target mainCamera"}
// @input SceneObject targetY {"hint":"Override default target mainCamera"}
// @input SceneObject targetX {"hint":"Override default target mainCamera"}
...
var Module = require("../../../../../Modules/Src/Assets/Spatialization/Scripts/MatchTransformLocal");
Object.setPrototypeOf(script, Module.MatchTransformLocal.prototype);
script.__initialize();
let awakeEvent = script.createEvent("OnAwakeEvent");
awakeEvent.bind(() => {
    checkUndefined("target", []);
    checkUndefined("targetZ", []);
    checkUndefined("targetY", []);
    checkUndefined("targetX", []);
