...
l9_12=varTangent.xyz;
l9_11=varNormalAndMotion.xyz;
l9_10=(sc_ModelMatrix*vec4((step(Port_Input0_N010,varColor.z)*l9_8.x)+l9_9.x,(step(Port_Input0_N008,varColor.x)*l9_8.y)+l9_9.y,l9_7.z,1.0)).xyz;
}
...
uniform float Port_Value2_N007;
uniform int PreviewEnabled;
...
vec4 l9_2=vec4((((sc_ModelMatrixInverse*vec4(varPosAndMotion.xyz,1.0)).xy+l9_1)+vec2(Port_Input0_N016*l9_0.x,Port_Input0_N017*l9_0.y))/((l9_1+vec2(cornerRadius))+vec2(1.234e-06)),Port_Value2_N007,0.0);
...
{
l9_8=(1.0-dot(l9_2.xyz,vec3(0.33333001)))*0.0;
}
#else
{
float l9_9;
...
{
l9_9=(1.0-clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0))*0.0;
}
#else
{
float l9_10;
...
{
l9_10=clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0)*0.0;
}
#else
{
float l9_11;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_12=clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0)*0.0;
}
#else
{
float l9_13;
...
{
l9_13=dot(l9_2.xyz,vec3(0.33333001))*0.0;
}
#else
{
float l9_14;
...
#endif
vec4 l9_21=vec4(l9_18.x,l9_18.y,l9_18.z,vec4(0.0).w);
l9_21.w=1.0;
l9_17=l9_21;
}
#else
